...
namespace DowJones.Web.UI
{
    ...
    [TestClass]
    public class ClientTemplateProcessorTests : UnitTestFixtureBase<ClientTemplateParser>
    {
        protected ClientTemplateParser Parser
        {
        ...
        protected override ClientTemplateParser CreateUnitUnderTest()
        {
            return new ClientTemplateParser();
        }
    }
}
