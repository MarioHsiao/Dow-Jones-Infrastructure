...
namespace DowJones
{
    public abstract class AbstractUnitTest
    {
        ...
        protected ControlData ControlData = ControlDataManager.GetLightWeightUserControlData("dacostad", "brian", "16");
        protected IPreferences Preferences = new BasePreferences
                                                 {
