...
namespace DowJones.Web.Mvc.UI.Components.TranslateArticle
{
    ...
    public class TranslateArticleModel: ViewComponentModel
    {
        ...
        /// </summary>
        private readonly UpdateRatingsResponseDelegate _ratingsReponseState=null;

        /// <summary>
        /// ArticleTranslator Response
        /// </summary>
        private readonly ArticleTranslatorResponseDelegate _state=null;
        ...
        {
            _ratingsReponseState = new UpdateRatingsResponseDelegate();
            _state = new ArticleTranslatorResponseDelegate();
