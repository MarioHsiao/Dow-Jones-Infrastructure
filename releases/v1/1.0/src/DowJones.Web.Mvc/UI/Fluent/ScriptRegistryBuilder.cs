...
namespace DowJones.Web.Mvc.UI
{
    public class ScriptRegistryBuilder : ComponentBuilderBase<IScriptRegistry, ScriptRegistryBuilder>
    {
        ...
        public virtual ScriptRegistryBuilder WithUnderscoreJS(bool enabled = true)
        {
            ...
            RegisterFrameworkWebResource(EmbeddedResources.Js.Underscore, ClientResourceDependencyLevel.MidLevel, enabled);
        ...
        public void RenderPartial(HtmlTextWriter writer)
        {
            _scriptRegistryWriter.RenderPartial(this, writer);
        }
