...
namespace DowJones.Utilities.Handlers.Syndication.ReadSpeaker
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class BaseContentHandler : BaseHttpHandler
    {
        ...
        public override void HandleRequest(HttpContext context)
        {
            ...
            string token = context.Request[ContentUrlBuilder.QsParamToken];
        ...
        {
            ControlData userControlData = Factiva.Gateway.Managers.ControlDataManager.AddProxyCredentialsToControlData(
                ControlDataManager.GetLightWeightUserControlData(Settings.Default.PodcastLightweightUser),
            ...
            try
            {
                ...
                if (_archiveResponse != null)
                {
                        ...
                        articleResponse.articleResponseSet.article != null)
                    {
                        ...
                        {
                            Article article = articleResponse.articleResponseSet.article[0];
                            ...
                            string lang = article.baseLanguage;
                            int wordCount = article.wordCount;
        ...
        private bool AllowContentReader(int wordCount, string baseLanguage)
        {
            ...
            char[] delimiterChars = {','};
            string[] langs = _supportedLanguages.Split(delimiterChars);
        ...
        {
            string value = GetEmbeddedXslt(CONTENT_READER_XSLT);
        ...
        private static void FireRecordOperationalDataRequest(ControlData userControlData, IBaseOperationalData articlePostProcessingViewOperationalData)
        {
            try
            {
                ControlData controlData = ControlDataManager.Clone(userControlData);
