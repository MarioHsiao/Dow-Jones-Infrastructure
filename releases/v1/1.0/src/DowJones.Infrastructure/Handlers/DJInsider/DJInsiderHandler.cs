    ...
    public class DJInsiderHandler : BaseHttpHandler
    {
        ...
        private DJIResponseDTO DeleteDowJonesInsiderSubscription(DJIRequestDTO dto)
        {
            ...
            try
            {
                ...
                var serviceResponse = EmailDeliverySettingsService.DeleteWhatsNewSettings(_controlData, deleteWhatsNewSettingsRequest);
        ...
        private DJIResponseDTO UpdateDowJonesInsiderSubscription(DJIRequestDTO dto)
        {
            ...
            try
            {
                ...
                var serviceResponse = EmailDeliverySettingsService.UpdateWhatsNewSettings(_controlData, updateWhatsNewSettingsRequest);
        ...
        private DJIResponseDTO AddDowJonesInsiderSubscription(DJIRequestDTO dto)
        {
            ...
            try
            {
                ...
                var serviceResponse = EmailDeliverySettingsService.AddWhatsNewSettings(_controlData, addWhatsNewSettingsRequest);
        ...
        private DJIResponseDTO GetDowJonesInsiderSubscription()
        {
            ...
            try
            {
                ...
                var serviceResponse = EmailDeliverySettingsService.GetWhatsNewSettings(_controlData, getWhatsNewSettingsRequest);
        ...
        private void UpdateDJIPreferenceItem(string itemID, DowJonesInsiderStatePreference djiState)
        {
            ...
            request.Item = item;
            ServiceResponse serviceResponse = PreferenceService.UpdateItem(ControlDataManager.Clone(_controlData),
                                                                           request);
        ...
        private DowJonesInsiderStatePreferenceItem GetDJIPreferenceItem()
        {
            ...
            var preferenceResponse = PreferenceService.GetItemsByClassID(ControlDataManager.Clone(_controlData), request);
        ...
        private string AddDJIPreferenceItem()
        {
            ...
            var serviceResponse = PreferenceService.AddItem(ControlDataManager.Clone(_controlData), request);
            if (serviceResponse == null)
            {
