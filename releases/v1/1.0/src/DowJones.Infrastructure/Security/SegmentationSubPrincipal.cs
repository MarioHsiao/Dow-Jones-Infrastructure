...
namespace DowJones.Utilities.Security
{
    ...
    public class SegmentationSubPrincipal : ISubPrincipal
    {
        private readonly List<ThirdPartyServices> _thirdPartyServices = new List<ThirdPartyServices>();
        ...
        {
            get { return _thirdPartyServices; }
        }
        ...
        private void InitializeAC2(string value)
        {
            ...
            foreach (string s in vals)
            {
                ...
                {
                    case "TRIB":
                        _thirdPartyServices.Add(Security.ThirdPartyServices.TributesDotCom);
                        break;
                    case "NOZA":
                        _thirdPartyServices.Add(Security.ThirdPartyServices.NozaCharitableData);
                        break;
                    case "MARK":
                        _thirdPartyServices.Add(Security.ThirdPartyServices.MarketData);
                        break;
                }
            }
        }
        ...
        internal SegmentationSubPrincipal()
        {
        }

        internal SegmentationSubPrincipal(MatrixFSService service)
        {
            Initialize(service);
        }
