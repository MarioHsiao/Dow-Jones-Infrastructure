...
{
    public class GermanGermanyRegionalCulture : BaseLatinRegionalCulture
    {
        private const string REGION_CODE = "DE";
        private const string TWO_LETTER_ISO_LANGUAGE_NAME = "de";
