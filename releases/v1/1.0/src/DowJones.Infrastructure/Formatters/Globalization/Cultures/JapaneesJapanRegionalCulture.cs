...
{
    public class JapaneesJapanRegionalCulture : BaseAsianRegionalCulture
    {
        private const string REGION_CODE = "JP";
        private const string TWO_LETTER_ISO_LANGUAGE_NAME = "ja";
