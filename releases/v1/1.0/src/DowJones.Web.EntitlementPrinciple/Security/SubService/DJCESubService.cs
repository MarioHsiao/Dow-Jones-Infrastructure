// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DJCESubService.cs" company="Dow Jones">
...
namespace EMG.Utility.Security
{
    ...
    /// This uses the Interface piece of the Authorization Component
    /// </summary>
    public class DJCESubService : ISubService
    {
        #region Constructor(s)

        internal DJCESubService()
        {
        }

        internal DJCESubService(MatrixInterfaceService service)
        {
            Initialize(service);
        }
