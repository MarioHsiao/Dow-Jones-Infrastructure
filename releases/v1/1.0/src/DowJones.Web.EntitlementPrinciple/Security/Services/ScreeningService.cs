...
namespace DowJones.Web.EntitlementPrinciple.Security.Services
{
    ...
    public class ScreeningService : AbstractService, IScreeningService
    {
        ...
        internal override sealed void Initialize()
        {
            ...
            IsRadarOn = ListUtility.HasAccess(_matrixScreening.ac2.ToArray(), "RADAR", "ON");
            IsExtendedScreeningOn = ListUtility.HasAccess(_matrixScreening.ac3.ToArray(), "UNIVERSE", "FULL");
        }
        ...
        private static bool HasScreeningAccess(string[] acCol, string screening)
        {
            ...
            return ListUtility.HasAccess(tokensCol, screening, "FULL") || ListUtility.HasAccess(tokensCol, screening, "BASIC");
        }
