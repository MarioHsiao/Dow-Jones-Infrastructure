...
namespace DowJones.Web.EntitlementPrinciple.Security.Services
{
    ...
    public class SnapshotService : AbstractService, ISnapshotService
    {
        ...
        internal override sealed void Initialize()
        {
            ...
            IsCorporateFamilyOn = IsPremiumSnapshotOn = ListUtility.HasAccess(_matrixSnapshot.ac2.ToArray(), "COFTFULL", "ON");
        }
        ...
        private static bool HasSnapshotAccess(string[] acCol, string snapshot)
        {
            ...
            return ListUtility.HasAccess(tokensCol, snapshot, "ON");
        }
