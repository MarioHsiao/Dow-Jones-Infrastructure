...
namespace DowJones.Web.Mvc.UI
{
    ...
    public abstract class ViewComponentBase : RazorTemplateBase, IViewComponent, IViewDataContainer, IView
    {
        ...
        {
            [DebuggerStepThrough]
            get { return GetHtmlAttribute<string>("class"); }
            [DebuggerStepThrough]
        ...
        protected ViewComponentBase(IEnumerable<IViewComponent> children)
        {
            ...
            IEnumerable<ClientResource> clientResources = AutoDiscoverClientResources();
        ...
        protected virtual void InitializeClientPlugin(TextWriter writer)
        {
            ...
            objectWriter.AppendKeyValuePairs("tokens", clientState.Tokens);
        ...
        protected virtual IEnumerable<ClientResource> AutoDiscoverClientResources()
        {
            ...
            if (ClientResourcesCache.ContainsKey(type))
                return ClientResourcesCache[type];
            ...
            ClientResourcesCache.Add(type, resources);
        ...
        {
            // Razor templates needn't override this, but
