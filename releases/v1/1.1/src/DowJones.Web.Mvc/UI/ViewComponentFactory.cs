...
{
    public class ViewComponentFactory : IAmFluent
    {
        ...
        private readonly ViewComponentModelMapper _viewComponentModelMapper;
        ...
        protected ViewComponentFactory(
                ...
                ViewComponentModelMapper viewComponentModelMapper,
            ...
            )
        {
            ...
            _viewComponentModelMapper = viewComponentModelMapper;
        }
        ...
        public virtual IViewComponent Create(object model, IDictionary<string, object> htmlAttributes = null)
        {
            ...
            var componentType =
                _viewComponentModelMapper.GetComponentTypeFromDataType(dataType);

            var component = Create(componentType, model, htmlAttributes);
