            ...
            if (_matrixCibsService != null)
                {
                    ...
                    {
                        HasAccessToUsageReports = !ListUtility.FindInList(_matrixCibsService.ac1, "N");
                    }

                    if (_matrixCibsService.ac2 != null &&
                        _matrixCibsService.ac2.Count > 0)
                    {
                        HasAccessToOtherUsersUsageReports = ListUtility.FindInList(_matrixCibsService.ac2, "Y");
                    }
                }
        }
    }
