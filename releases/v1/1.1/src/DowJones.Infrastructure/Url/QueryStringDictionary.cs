...
namespace DowJones.Utilities.Url
{
    public class QueryStringDictionary : Dictionary<string, string>
    {
        ...
        /// <param name="name">The name.</param>
        /// <param name="value">The value.</param>
        internal void Append(string name, int value)
        {
        ...
        /// <param name="name">The name.</param>
        /// <param name="value">The value.</param>
        internal void Append(string name, double value)
        {
            Append(name, value.ToString());
        }
        ...
        /// <param name="name">The name.</param>
        /// <param name="value">The value.</param>
        internal void Append(string name, float value)
        {
            Append(name, value.ToString());
        }
        ...
        internal void Append(string name, bool value)
        {
        ...
        /// <param name="name">The name.</param>
        /// <param name="values">The values.</param>
        internal void Append(string name, string[] values)
        {
            if (string.IsNullOrEmpty(name))
            {
                return;
