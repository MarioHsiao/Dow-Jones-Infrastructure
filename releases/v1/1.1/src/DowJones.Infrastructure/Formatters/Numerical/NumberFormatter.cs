...
namespace DowJones.Utilities.Formatters.Numerical
{
    /// <summary>
    ...
    public class NumberFormatter : IFormatter<Number>
    {
        ...
        /// <returns>The formatted string.</returns>
        internal static Text GetFormattedText(double number, NumberFormatType numberFormatType)
        {
            var text = new Text
                           {
        ...
        internal static string GetFormattedString(double value, NumberFormatType numberFormatType, int precision)
        {
            ...
            switch (numberFormatType)
            {
                ...
                case NumberFormatType.PercentageStock:
                    nf.NumberDecimalDigits = 2;
                    return value > 0 ? string.Concat("+", value.ToString("N", nf), "%") : value.ToString("N", nf);
