...
{
    public class ItalianItalyRegionalCulture : BaseLatinRegionalCulture
    {
        private const string REGION_CODE = "IT";
        private const string TWO_LETTER_ISO_LANGUAGE_NAME = "it";
