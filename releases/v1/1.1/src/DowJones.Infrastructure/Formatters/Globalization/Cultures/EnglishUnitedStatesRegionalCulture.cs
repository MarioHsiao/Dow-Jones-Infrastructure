...
{
    public class EnglishUnitedStatesRegionalCulture : BaseLatinRegionalCulture
    {
        private const string REGION_CODE = "US";
        private const string TWO_LETTER_ISO_LANGUAGE_NAME = "en";
