// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ControlExtensions.cs" company="Dow Jones">
...
public static class ControlExtensions
{
    ...
    public static Control FindControlRecursive(this Control control, string id)
    {
        foreach (Control child in control.Controls)
        {
            if ((child.ID != null) && string.Equals(child.ID, id, StringComparison.InvariantCultureIgnoreCase))
            {
                return child;
            }
    ...
    public static T FindControlRecursive<T>(this Control control, string id) where T : class
    {
        foreach (Control child in control.Controls)
        {
            if ((child.ID != null) && string.Equals(child.ID, id, StringComparison.InvariantCultureIgnoreCase) && (child is T))
            {
                return child as T;
            }
    ...
    /// <returns>A IEnumerate of the type</returns>
    /// <example><code>
