...
{
    [Serializable]
    public class FileUploadHandlerResponseDelegate : AbstractAjaxResponseDelegate
    {
        ...
        public string ToXml()
        {
            ...
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(FileUploadHandlerResponseDelegate));
