...
namespace DowJones.Tools.Charting.Discovery
{
    public class DiscoveryChartGenerator : AbstractChartGenerator
    {
        ...
        private bool hasCJK;
        //private bool hasArabicSlashHebrew;
        ...
        private InterfaceLanguage interfaceLanguage = InterfaceLanguage.en;
        ...
        public DiscoveryChartGenerator() : this(new DiscoveryChartDataSet())
        {
        }
        ...
        public DiscoveryChartGenerator(DiscoveryChartDataSet dataSet)
        {
            ...
            dateTimeFormatter = new DateTimeFormatter(InterfaceLanguage.ToString(), DateTimeFormatingPreference);
        }
        ...
        internal string ToITXML(bool includeSampleData)
        {
            ...
            else if (includeSampleData)
            {
                ...
                mainSB.AppendFormat(SAMPLE_DATA, ResourceTextManager.Instance.GetString(discoveryChartTypeStr));
            }
