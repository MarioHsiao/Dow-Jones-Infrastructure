...
namespace DowJones.Utilities.Managers.Search.Responses
{
    ...
    {
        [XmlAttribute(AttributeName = "canReturnDiscoveryData", Form = XmlSchemaForm.Unqualified, DataType = "boolean", Namespace = Declarations.SchemaVersion)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public bool __canReturnDiscoveryData;

        [XmlIgnore]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public bool __canReturnDiscoveryDataSpecified;

        [XmlIgnore]
        public bool CanReturnDiscoveryData
        {
            get { return __canReturnDiscoveryData; }
            set { __canReturnDiscoveryData = value; __canReturnDiscoveryDataSpecified = true; }
        }
