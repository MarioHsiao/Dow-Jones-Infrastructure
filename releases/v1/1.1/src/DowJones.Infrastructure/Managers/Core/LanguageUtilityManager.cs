...
using Factiva.Gateway.Messages.Common;
    ...
    public class LanguageUtilityManager
    {
        ...
        public static string[] GetSearchLanguages(string interfaceLanguage)
        {
            ...
            if (!string.IsNullOrEmpty(interfaceLanguage) &&
                Enum.IsDefined(typeof(ContentLanguage), interfaceLanguage.ToLower()) &&
                ...
                foreach (BrowserAcceptedLangs t in brow)
                {
                    switch (t.Code)
                    {
                        default:
                            ...
                            if (Enum.IsDefined(typeof(ContentLanguage), temp.ToLower()) &&
                            ...
                            else if (temp.ToLower() == "zh")
                            {
                                ...
                                if (!ar.Contains(ContentLanguage.zhcn.ToString()))
                                {
                                    ar.Add(ContentLanguage.zhcn.ToString());
                                    ar.Add(ContentLanguage.zhtw.ToString());
                                }
                            }
