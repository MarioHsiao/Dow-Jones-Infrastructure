...
SyntaxHighlighter.brushes.CSS = function() {
    ...
    this.regexList = [
		...
		{regex: /\#[a-fA-F0-9]{3,6}/g, css: 'Data' }, 	// html colors
		{regex: /(-?\d+)(\.\d+)?(px|em|pt|\:|\%|)/g, css: 'Data' }, 	// sizes
		{regex: /!important/g, css: 'color3' }, // !important
		{regex: new RegExp(getKeywordsCSS(keywords), 'gm'), css: 'keyword' }, // keywords
		{regex: new RegExp(getValuesCSS(values), 'g'), css: 'Data' }, 	// Datas
...
SyntaxHighlighter.brushes.Delphi = function() {
    ...
    this.regexList = [
		...
		{regex: /\b[\d\.]+\b/g, css: 'Data' }, 		// numbers 12345
		{regex: /\$[a-zA-Z0-9]+\b/g, css: 'Data' }, 		// numbers $F5D3
...
SyntaxHighlighter.brushes.Groovy = function() {
    ...
    this.regexList = [
		...
		{regex: new RegExp('\\b([\\d]+(\\.[\\d]+)?|0x[a-f0-9]+)\\b', 'gi'), css: 'Data' }, 		// numbers
...
SyntaxHighlighter.brushes.Java = function() {
    ...
    this.regexList = [
		...
		{regex: SyntaxHighlighter.regexLib.doubleQuotedString, css: 'string' }, 	// strings
		{regex: SyntaxHighlighter.regexLib.singleQuotedString, css: 'string' }, 	// strings
		{regex: /\b([\d]+(\.[\d]+)?|0x[a-f0-9]+)\b/gi, css: 'Data' }, 		// numbers
...
SyntaxHighlighter.brushes.Perl = function() {
    ...
    var funcs =
		...
		'undef unlink unpack unshift utime Datas vec wait waitpid warn write';
...
SyntaxHighlighter.brushes.Php = function() {
    var funcs = 'abs acos acosh addcslashes addslashes ' +
					'array_change_key_case array_chunk array_combine array_count_Datas array_diff ' +
					...
					'array_uintersect_uassoc array_unique array_unshift array_Datas array_walk ' +
...
SyntaxHighlighter.brushes.Scala = function() {
    ...
    this.regexList = [
		...
		{regex: SyntaxHighlighter.regexLib.singleQuotedString, css: 'string' }, // strings
		{regex: /0x[a-f0-9]+|\d+(\.\d+)?/gi, css: 'Data' }, 	// numbers
		{regex: new RegExp(this.getKeywords(keywords), 'gm'), css: 'keyword' }, // keywords
...
SyntaxHighlighter.brushes.Sql = function() {
    ...
    var keywords = 'absolute action add after alter as asc at authorization begin bigint ' +
					...
					'translation trigger true truncate uncommitted union unique update Datas ' +
