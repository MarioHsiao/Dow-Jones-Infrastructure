...
namespace DowJones.Web.Mvc.UI.Components.CompositeHeadline
{
    ...
    // Last Generated Timestamp: 11/14/2011 07:50 PM
    [DowJones.Web.ScriptResourceAttribute(null, ResourceName="DowJones.Web.Mvc.UI.Components.CompositeHeadline.CompositeHeadline.js", ResourceKind=DowJones.Web.ClientResourceKind.Script, DeclaringType=typeof(DowJones.Web.Mvc.UI.Components.CompositeHeadline.CompositeHeadline))]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("RazorViewComponentClassGenerator", "0.0.0.30158")]
    public class CompositeHeadline : DowJones.Web.Mvc.UI.CompositeComponent<DowJones.Web.Mvc.UI.Components.CompositeHeadline.CompositeHeadlineModel>
    {
#line hidden

        public CompositeHeadline()
        {
        }
...
Write(Html.DJ().RenderComponent<PostProcessing.PostProcessing>(Model.PostProcessing));

                                                                                     
}


Write(Html.DJ().RenderComponent<HeadlineList.HeadlineListControl>(Model.HeadlineList));
