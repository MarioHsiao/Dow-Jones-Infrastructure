...
namespace DowJones.Web.Showcase.Controllers
{
    public class PersonalizationFiltersController : ControllerBase
    {
        public ActionResult Index()
        {
            var model = new PersonalizationFiltersModel
                            {
                                ...
                                IndustryFilter = new CodeDesc { Code = "i836", Desc = "Accounting" },
                                RegionFilter = new CodeDesc { Code = "i836", Desc = "Asia" },
                                Disabled = true
                            };
            ...
            //var model = new TaxonomySearchBrowseModel();
