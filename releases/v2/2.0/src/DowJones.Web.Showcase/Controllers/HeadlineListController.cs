    ...
    public class HeadlineListController : Controller
    {
        ...
        public ActionResult Composite(string q = "asp.net", ContentSearchMode? mode = null)
        {
            ...
            CompositeHeadlineModel model = new CompositeHeadlineModel()
                                               {
                                                   FirstResultIndex =
                                                       (int) showcaseHeadlineListModel.Result.resultSet.first.Value,
                                                   LastResultIndex =
                                                       (int) showcaseHeadlineListModel.Result.resultSet.count.Value,
                                                   TotalResultCount =
                                                       (int) showcaseHeadlineListModel.Result.hitCount.Value,
                                                   HeadlineList =
                                                       new DowJones.Web.Mvc.UI.Components.HeadlineList.HeadlineListModel
                                                       (showcaseHeadlineListModel.Result)
                                                           {
