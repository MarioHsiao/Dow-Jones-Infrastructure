...
namespace DowJones.Managers.Search
{
    ...
    public partial class SearchManager : AbstractAggregationManager
    {
        ...
        private IPerformContentSearchResponse GetPerformContentSearchResponse<TIPerformContentSearchRequest, TIPerformContentSearchResponse>(IControlData overriableControlData, ISearchRequest searchRequest) 
            where TIPerformContentSearchRequest : IPerformContentSearchRequest, new()
        ...
        private IPerformContentSearchResponse GetPerformContentSearchResponse<TIPerformContentSearchResponse>(IControlData overriableControlData, IPerformContentSearchRequest request)
    {
        try
        {
        ...
        private PerformMetadataSearchResponse GetPerformMetadataSearchResponse(PerformMetadataSearchRequest request)
        {
            try
            {
