...
self.worldMapRenderer.image('<%= WebResource("DowJones.Web.Mvc.UI.Controls.RegionalMap.images.world_map.gif") %>', self.mapX, self.mapY, self.mapWidth, self.mapHeight).add();
