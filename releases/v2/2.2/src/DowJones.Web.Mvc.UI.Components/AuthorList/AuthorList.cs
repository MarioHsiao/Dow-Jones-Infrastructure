...
namespace DowJones.Web.Mvc.UI.Components.AuthorList
{
    ...
    // Last Generated Timestamp: 03/21/2012 03:17 PM
...
"d>\r\n\t\t\t<tr>\r\n\t\t\t\t<th></th>\r\n\t\t\t\t<th></th>\r\n\t\t\t\t<th></th>\r\n\t\t\t\t<th class=\"dj_col-" +
"string dj_sortable-table-header\" data-sort=\"contact\">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"outlet\">\r\n\t\t\t\t\t" +
"");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-column\">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"outlet-country\"" +
">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"outlet-state\">\r" +
"\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"outlet-city\">\r\n" +
"\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"outlet-type\">\r\n" +
"\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"outlet-frequenc" +
"y\">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-integer dj_sortable-table-header\" data-sort=\"circulation\" s" +
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"employment-type" +
"\">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"country\">\r\n\t\t\t\t" +
"\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"state\">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"city\">\r\n\t\t\t\t\t");
...
WriteLiteral("\t\t\t\t<th class=\"dj_col-string dj_sortable-table-header\" data-sort=\"job-title\">\r\n\t\t" +
"\t\t\t");
...
WriteLiteral(">\r\n\t\t\t\t<td class=\"dj_col-checkbox\">\r\n\t\t\t\t\t<input name=\"dj_author-select\" type=\"ch" +
"eckbox\" authorlist-aid=\'");
...
WriteLiteral("\' />\r\n\t\t\t\t</td>\r\n\t\t\t\t<td class=\"dj_col-row-id\">");


                          Write(runningSum++);

WriteLiteral(".</td>\r\n\t\t\t\t<td class=\"dj_col-collapser\">\r\n");


 					if (Model.AnyOutletRelatedColumn && author.ExpandableOutlet)
					{

WriteLiteral("\t\t\t\t\t\t<div class=\"dj_collapsable-icon collapsed\"></div>\r\n");
...
WriteLiteral("\t\t\t\t</td>\r\n\t\t\t\t<td class=\"dj_col-string\">\r\n\t\t\t\t\t<a href=\"javascript:void(0);\" cla" +
"ss=\"author-name-selector\">");
...
WriteLiteral("\t\t\t\t<td class=\"dj_col-string\">\r\n");
...
WriteLiteral("\t\t\t\t<td class=\"dj_col-integer\">\r\n");
...
WriteLiteral("\t\t\t\t\t\t\t<td class=\"dj_col-string\">\r\n\t\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" authorli" +
"st-outlet-id=\"");
