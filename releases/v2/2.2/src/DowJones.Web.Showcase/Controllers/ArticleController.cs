...
namespace DowJones.Web.Showcase.Controllers
{
    public class ArticleController : ControllerBase
    {
        ...
        public ActionResult MixedArticles(string pub, string web, string pic, string mul)
        {
            ...
            var articleResponse =  _articleService.GetArticles(new MixedContentArticleRequest() {ArticleReferences =  list, ResponseDataSet = new ResponseDataSet() {articleFormat = ArticleFormatType.FULL}});
           
          
            _articleService.GetArticles(new MixedContentArticleRequest() {ArticleReferences =  list, ResponseDataSet = new ResponseDataSet {articleFormat = ArticleFormatType.FULL}});
