...
namespace System.Threading.Async
{
    ...
    public sealed class AsyncBarrier
    {
        ...
        private TaskCompletionSource<object> currentSignalTask;
        ...
        public AsyncBarrier(int participantCount)
        {
            ...
            currentSignalTask = new TaskCompletionSource<object>();
        }

        /// <summary>Gets the participant count.</summary>
        public int ParticipantCount { get { return participantCount; } }
        /// <summary>Gets the number of participants still not yet arrived in this round.</summary>
        public int RemainingCount { get { return remainingParticipants; } }
