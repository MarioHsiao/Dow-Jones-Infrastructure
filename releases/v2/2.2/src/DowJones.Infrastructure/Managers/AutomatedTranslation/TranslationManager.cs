...
using DowJones.Managers.AutomatedTranslation.Providers.LanguageWeaver;
using DowJones.Mapping.AutomatedTranslation;
...
namespace DowJones.Managers.AutomatedTranslation
{
    ...
    public class TranslationManager : AbstractAggregationManager, ITranslationManager
    {
        ...
        /// </param>
        public TranslationManager(IControlData controlData, string interfaceLanguage)
            : base(controlData)
        {
        }
