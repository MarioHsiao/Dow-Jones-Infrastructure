...
namespace DowJones.Charting.Highcharts
{
    ...
    /// 
    /// </summary>
    public class SaveImageHttpHandler : Page, IHttpAsyncHandler
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            var handlerType = typeof(BaseSaveImageHttpHandler);
    ...
    /// </summary>
    public class BaseSaveImageHttpHandler : IHttpHandler
    {
        /// <summary>
