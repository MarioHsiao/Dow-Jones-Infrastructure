...
namespace DowJones.Thunderball.Library
{
    ...
    public class GetChartRequest : object, IExtensibleDataObject
    {
        ...
        [DataMember]
        public int XAxisPadding { get; set; }

        [DataMember]
        public int YAxisPadding { get; set; }
...
namespace DowJones.Thunderball.Library.Charting
{
    ...
    {
        [DataMember]
        public double BarFactor { get; set; }
        ...
        [DataMember]
        public Dictionary<string, SessionInfo> Data { get; set; }

        [DataMember]
        public string Error { get; set; }

        [DataMember]
        public XAxisLabelInfo xAxisLabelInfo { get; set; }

        [DataMember]
        public XAxisDataMembers xAxisLabelsObj { get; set; }
...
public class ChartServiceClient : ClientBase<IChartService>, IChartService
{
                                        ...
                                        DateTime? EndDate, int Width, int Height)
    {
        ...
        inValue.EntitlementToken = EntitlementToken;
        inValue.RequestId = RequestId;
        inValue.XAxisPadding = XAxisPadding;
        inValue.YAxisPadding = YAxisPadding;
        ...
        GetVMLChartResponse retVal = ((IChartService)(this)).GetVMLChart(inValue);
    ...
    public string GetChartStyle(string StyleName)
    {
        ...
        inValue.StyleName = StyleName;
        GetChartStyleResponse retVal = ((IChartService)(this)).GetChartStyle(inValue);
