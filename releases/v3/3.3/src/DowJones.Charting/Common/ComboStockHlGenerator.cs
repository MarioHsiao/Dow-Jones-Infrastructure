...
{
    public class ComboStockHlGenerator : AbstractChartGenerator
    {
        private const string BASE_APPERANCE_FILE = "common/chart_hl.itxml";
        private const string BASE_APPERANCE_FILE_HVOLUME = "common/chart_hl_hvolume.itxml";
        ...
        public ComboStockHlGenerator()
        {


        }

        public ComboStockHlGenerator(StockChartDataSet DataSet)
        {
            m_DataSet = DataSet;
        }
