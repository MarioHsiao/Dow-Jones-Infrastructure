...
namespace DowJones.Assemblers.Headlines
{
    ...
    /// </summary>
    internal class GatewayAccessionNumberSearchResponseConverter : AbstractHeadlineListDataResultSetConverter, IExtendedListDataResultConverter
    {
        /// <summary>
        /// The logger.
        /// </summary>
        protected static readonly ILog Log = LogManager.GetLogger(typeof(GatewayAccessionNumberSearchResponseConverter));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayAccessionNumberSearchResponseConverter"/> class. 
        ...
        /// </param>
        public GatewayAccessionNumberSearchResponseConverter(AccessionNumberSearchResponse response, string interfaceLanguage)
        ...
        /// The response.
        /// </param>
        public GatewayAccessionNumberSearchResponseConverter(AccessionNumberSearchResponse response)
            : this(response, "en")
        {
        }
        ...
        /// </param>
        public GatewayAccessionNumberSearchResponseConverter(AccessionNumberSearchResponse response, DateTimeFormatter dateTimeFormatter)
