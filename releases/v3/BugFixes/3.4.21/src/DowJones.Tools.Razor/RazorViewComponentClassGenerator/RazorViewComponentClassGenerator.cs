...
#pragma warning restore 0414
        ...
        protected override byte[] GenerateCode(string inputFileContent)
        {
            try
            {
                ...
                var viewComponent = templateGenerator.Generate(results, provider, CodeGeneratorOptions);
        ...
        private ViewComponentGenerator GetRazorTemplateGenerator()
        {
            ...
            var generator = new ViewComponentGenerator(virtualPath, InputFilePath, FileNameSpace);
