...
{
    public class RussianRussiaRegionalCulture : BaseLatinRegionalCulture
    {
        private const string REGION_CODE = "RU";
        private const string TWO_LETTER_ISO_LANGUAGE_NAME = "ru";
