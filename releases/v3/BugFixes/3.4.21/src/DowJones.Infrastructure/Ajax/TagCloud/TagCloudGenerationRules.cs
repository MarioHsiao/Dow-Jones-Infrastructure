...
namespace DowJones.Ajax.TagCloud
{
    /// <summary>
    ...
    public class TagCloudGenerationRules
    {
        ...
        private int? _maxNumberOfTags;
        private TagCloudOrder _order;
        private double _requiredTagWeight;
        private string _tagToolTipFormatString;
        private string _tagUrlFormatString;
        private int[] _weightClassPartitioning;
        ...
        {
            get { return _tagUrlFormatString ?? string.Empty; }
            set { _tagUrlFormatString = value; }
        }
        ...
        public TagCloudOrder Order
        {
            ...
            set
            {
                if (!Enum.IsDefined(typeof (TagCloudOrder), value))
                    throw new ArgumentOutOfRangeException("Ord" + "er"); //Throw exception for enum type safety
        ...
        public int? MaxNumberOfTags
        {
            ...
            set
            {
                if (_maxNumberOfTags < 1)
                    throw new ArgumentException("Must be a positive integer.", "MaxNumb" + "erOfTags");

                _maxNumberOfTags = value;
            }
        }
        ...
        /// </summary>
        public double RequiredTagWeight
        {
            get { return _requiredTagWeight; }
            set
            {
                if (value <= 0)
                    throw new ArgumentException("Must be a positive double.", "Requir" + "edTagWeight");

                _requiredTagWeight = value;
            }
        }
        ...
        {
            get { return _tagToolTipFormatString ?? string.Empty; }
            set { _tagToolTipFormatString = value; }
        }
     ...
     /*   /// <summary>
        ...
        /// </summary>
        internal string TagCssClassPrefix
        {
            get { return _tagCssClassPrefix; }
            set
            {
                if (string.IsNullOrEmpty(value))
                    throw new ArgumentException("TagCssClassPrefix must have a non empty string value.");
                _tagCssClassPrefix = value;
            }
        }*/
        ...
        /// </example>
        internal ReadOnlyCollection<int> WeightClassPartitioning
        {
            get { return new ReadOnlyCollection<int>(_weightClassPartitioning); }
            set
            {
                #region Validation
                ...
                if (_weightClassPartitioning == null)
                {
                    _weightClassPartitioning = new int[value.Count];
                }
                value.CopyTo(_weightClassPartitioning, 0);
            }
        }
