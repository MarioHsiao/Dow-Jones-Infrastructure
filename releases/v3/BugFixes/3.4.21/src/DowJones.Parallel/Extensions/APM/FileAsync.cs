...
namespace System.IO
{
    ...
    public static class FileAsync
    {
        ...
        /// <returns>
        /// A task that will signal the completion of the operation.
        /// </returns>
        ...
        public static Task<string> ReadAllText(string path)
        {
            ...
            var asyncRead = fs.ReadBuffersAsync(BufferSize, (buffer, count) => text.Append(encoding.GetString(buffer, 0, count)));
