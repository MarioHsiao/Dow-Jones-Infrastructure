...
namespace DowJones.Web.Handlers.Items
{
    public class PAMItemManager
    {
        ...
        public long CreateItem(Item item, IControlData m_ControlData)
        {
            long itemId = -1;
            ...
            try
            {
                ...
                ServiceResponse serviceResponse = ItemService.CreateItem(ControlDataManager.Convert(m_ControlData),
                                                                         createItemRequest);
        ...
        public void UpdateItemName(long itemId, string newName, IControlData m_ControlData)
        {
            ...
            try
            {
                ...
                ServiceResponse serviceResponse = ItemService.UpdateItemName(ControlDataManager.Convert(m_ControlData),
        ...
        public Item getItemById(long itemId, IControlData m_ControlData)
        {
            Item result = null;
            ...
            try
            {
                ...
                ServiceResponse serviceResponse = ItemService.GetItemByID(ControlDataManager.Convert(m_ControlData), getItemByIdRequest);
                if (serviceResponse.rc == 0)
                {
                    object responseObj;
                    long responseObjRC = serviceResponse.GetResponse(ServiceResponse.ResponseFormat.Object,
        ...
        public void DeleteItem(long itemId, IControlData m_ControlData)
        {
            ...
            try
            {
                ...
                ServiceResponse serviceResponse = ItemService.DeleteItem(ControlDataManager.Convert(m_ControlData), deleteItemRequest);
                if (serviceResponse.rc == 0)
                {
                    object responseObj;
                    long responseObjRC = serviceResponse.GetResponse(ServiceResponse.ResponseFormat.Object,
