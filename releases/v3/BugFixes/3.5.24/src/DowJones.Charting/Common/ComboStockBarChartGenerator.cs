...
namespace DowJones.Charting.Common
{
    ...
    public class ComboStockBarChartGenerator : AbstractChartGenerator
    {
        private const string BASE_APPERANCE_FILE = "common/chart_candlestick.itxml";
        private const string BASE_APPERANCE_FILE_HVOLUME = "common/chart_candlestick_hvolume.itxml";
        ...
        public ComboStockBarChartGenerator()
        {
            

        }

        public ComboStockBarChartGenerator(StockChartDataSet DataSet)
        {
            m_DataSet = DataSet;
        }
