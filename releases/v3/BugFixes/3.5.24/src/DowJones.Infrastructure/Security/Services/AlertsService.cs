...
namespace DowJones.Security.Services
{
    ...
    public class AlertsService : AbstractService, IAlertsService
    {
        ...
        public bool HasPressClipsEnabled { get; private set; }
        ...
        internal override sealed void Initialize()
        {
            ...
            var trackAc10 = _matrixTrackService.ac10.FirstOrDefault(x => x.HasValue());
            
            HasPressClipsEnabled = !string.IsNullOrEmpty(trackAc10);
