// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileInfoExtensions.cs" company="Dow Jones">
...
namespace DowJones.Extensions
{
    ...
    public static class FileInfoExtensions
    {
        ...
        /// </summary>
        /// <param name="files">The target files.</param>
        /// <param name="newExtension">The new extension.</param>
        ...
        public static string SuffixFileName(this FileInfo fileInfo, string suffix)
        {
            string changedFileName = string.Format(
                "{0}{1}.{2}",
                Path.GetFileNameWithoutExtension(fileInfo.Name),
                suffix,
                fileInfo.Extension.Substring(1));

            string filePath = Path.Combine(fileInfo.DirectoryName, changedFileName);
