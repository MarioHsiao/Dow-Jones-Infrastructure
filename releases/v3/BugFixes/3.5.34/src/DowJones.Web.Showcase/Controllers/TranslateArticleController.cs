...
{
    public class TranslateArticleController : ControllerBase
    {
        ...
        {
            var cd = ControlDataManager.GetLightWeightUserControlData("dacostad", "brian", "16");
            Session["cData"] = cd;
            ...
            token.SetLangCodeToken(string.IsNullOrEmpty(HttpContext.Request["targetlanguagecode"]) ? "es" : HttpContext.Request["targetlanguagecode"]);
            token.SetLangTextToken(string.IsNullOrEmpty(HttpContext.Request["targetlanguage"]) ? "es" : HttpContext.Request["targetlanguage"]);
            ...
            var translatearticle = new TranslateArticleModel
                                       {
                                           ...
                                           SourceLanguage = string.IsNullOrEmpty(HttpContext.Request["sourcelanguage"]) ? "en" : HttpContext.Request["sourcelanguage"],
                                           TargetLanguage = string.IsNullOrEmpty(HttpContext.Request["targetlanguagecode"]) ? "es" : HttpContext.Request["targetlanguagecode"],
        ...
        {
            var cData = Session["cData"] as IControlData;
            ...
            var serviceResponse = ArchiveService.GetArticle(ControlDataManager.Convert(cData), articleRequest);
