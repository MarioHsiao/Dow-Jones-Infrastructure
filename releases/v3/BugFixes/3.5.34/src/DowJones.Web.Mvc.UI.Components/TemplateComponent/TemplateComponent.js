DJ.UI.TemplateComponent = DJ.UI.Component.extend({
        ...
        events: {
            textOneClick: "textOneClick.dj.TemplateComponent",
            textTwoClick: "textTwoClick.dj.TemplateComponent"
        },

        // This method is called when the component is initialized
        init: function (element, meta) {
            var $meta = $.extend({ name: "TemplateComponent" }, meta);
...
// call databind if the data was already passed
    ...
    $.plugin('dj_TemplateComponent', DJ.UI.TemplateComponent);
    $dj.debug('Registered DJ.UI.TemplateComponent (extends DJ.UI.Component)');
