...
namespace DowJones.Web.Mvc.UI.Components.Article
{
    ...
    // Last Generated Timestamp: 07/19/2013 10:49 AM
            ...
            if (renderItem.ElinkItems.Count > 0)
            {
                foreach (var elinkItem in renderItem.ElinkItems)
                {
                    switch (elinkItem.ItemMarkUp)
                    {
                        ...
                        { elinkItemText = elinkItemText + "<span class='dj_article_highlight'>" + elinkItem.ItemText + "</span>"; } break;
                        case MarkUpType.Plain:
                        { elinkItemText = elinkItemText + elinkItem.ItemText; } break;
                            }
                    }
