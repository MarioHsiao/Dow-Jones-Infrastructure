    ...
    DJ.UI.CompositeHeadline = DJ.UI.CompositeComponent.extend({
        ...
        _initializeDelegates: function () {
            ...
            $.extend(this._delegates, {
                ...
                onPressClipsClick: $dj.delegate(this, this._onPressClipsClick),
        ...
        _initializeEventHandlers: function () {
            var self = this;
            this.subscribe('headlineCheck.dj.HeadlineList', this._delegates.onHeadlineCheck);//Headline Check
            this.subscribe('headlineClick.dj.HeadlineList', this._delegates.onHeadlineClick);//Headline Click
            ...
            this.subscribe('pressClipsClick.dj.HeadlineList', this._delegates.onPressClipsClick);
            ...
            this.subscribe('pressClipsClick.dj.PostProcessing', $dj.delegate(this, this._onPostProcessingClick, 'pressclip'));
        ...
        _onPostProcessingClick: function (cmd, postProcessingData) {
            if (cmd !== 'read' && cmd !== 'pressclip' && !postProcessingData) {
            ...
            if (cmd !== 'read' && cmd !== 'pressclip') { eventInfo.format = postProcessingData.format, eventInfo.hdlnFormat = postProcessingData.hdlnFormat };

            this.publish(this.events.postProcessingClick, eventInfo);
        },

        _onSelectAllCheck: function (args) {
            if (!this.headlineListComp) { $dj.warn('Couldn\'t find Simple HeadlineList component'); return; }
        ...
        _onPressClipsClick: function (data) {
            this.publish(this.events.postProcessingClick, { command: "pressclip", headlines: [data] });
        },
