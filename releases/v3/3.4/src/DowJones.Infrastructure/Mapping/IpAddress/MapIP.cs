...
using EMG.Utility.Readers.CSV;
using log4net;

namespace EMG.Utility.Mapping.IpAddress
{
    /// <summary>
    /// Summary description for Class1.
    /// </summary>
    public class MapIP : IDisposable
    {
        ...
        private const string m_IpToCCData_CacheName = "EMG.Utility.IpToCCData";
        private const string m_SrcGrp2SrcsData_CacheName = "EMG.Utility.SrcGrp2SrcsData";
        private readonly object m_SyncObject = new object();

        private bool m_IsDisposed;

        private static readonly ILog m_Log = LogManager.GetLogger(typeof (MapIP).FullName + ":" + MethodInfo.GetCurrentMethod().Name);
        ...
        private void AddToCache(string name, DataTable data)
        {
            //add the table to the cache
            if (HttpContext.Current != null)
            {
                
                HttpContext.Current.Cache.Add(name, m_IpToCCData, null, Cache.NoAbsoluteExpiration, Cache.NoSlidingExpiration, CacheItemPriority.Low, null);
