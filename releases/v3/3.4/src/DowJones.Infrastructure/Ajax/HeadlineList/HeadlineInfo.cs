...
namespace DowJones.Ajax.HeadlineList
{
    ...
    public class HeadlineInfo
    {
        ...
        public HeadlineInfo(string accessionNumber, int index)
        {
            this.reference = new Reference { guid = accessionNumber, type = "accessionNo" };
            this.isValid = false;
            this.index = new WholeNumber(index);
        }
        /// <summary>
        /// The _reference.
        /// </summary>
