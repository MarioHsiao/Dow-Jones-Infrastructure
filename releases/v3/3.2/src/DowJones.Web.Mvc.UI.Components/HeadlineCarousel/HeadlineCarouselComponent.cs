...
namespace DowJones.Web.Mvc.UI.Components.HeadlineCarousel
{
    ...
    [DowJones.Web.ClientTemplateResourceAttribute(null, ResourceName="DowJones.Web.Mvc.UI.Components.HeadlineCarousel.ClientTemplates.HeadlineHitCounts" +
        "Package.htm", ResourceKind=DowJones.Web.ClientResourceKind.ClientTemplate, TemplateId="headlineHitCountsPackage", DeclaringType=typeof(DowJones.Web.Mvc.UI.Components.HeadlineCarousel.HeadlineCarouselComponent))]
    [DowJones.Web.ClientTemplateResourceAttribute(null, ResourceName="DowJones.Web.Mvc.UI.Components.HeadlineCarousel.ClientTemplates.DiscoveredEntitie" +
        "sPackage.htm", ResourceKind=DowJones.Web.ClientResourceKind.ClientTemplate, TemplateId="discoveredEntitiesPackage", DeclaringType=typeof(DowJones.Web.Mvc.UI.Components.HeadlineCarousel.HeadlineCarouselComponent))]
    [DowJones.Web.ClientTemplateResourceAttribute(null, ResourceName="DowJones.Web.Mvc.UI.Components.HeadlineCarousel.ClientTemplates.NoData.htm", ResourceKind=DowJones.Web.ClientResourceKind.ClientTemplate, TemplateId="noData", DeclaringType=typeof(DowJones.Web.Mvc.UI.Components.HeadlineCarousel.HeadlineCarouselComponent))]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("RazorViewComponentClassGenerator", "1.0.0.22175")]
    public class HeadlineCarouselComponent : DowJones.Web.Mvc.UI.ViewComponentBase<HeadlineCarouselModel>
    {
#line hidden

        public HeadlineCarouselComponent()
        {
        }
