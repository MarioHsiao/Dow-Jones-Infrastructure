...
namespace System.Threading.Algorithms
{
    public static partial class ParallelAlgorithms
    {
            ...
            Action<int, int> body)
        {
            ...
            return Parallel.ForEach(Partitioner.Create(fromInclusive, toExclusive), parallelOptions, range => body(range.Item1, range.Item2));
        }
            ...
            Action<int, int, ParallelLoopState> body)
        {
            ...
            return Parallel.ForEach(Partitioner.Create(fromInclusive, toExclusive), parallelOptions, (range, loopState) => body(range.Item1, range.Item2, loopState));
        }

        /// <summary>
        /// Executes a for loop over ranges in which iterations may run in parallel.
        /// </summary>
        /// <typeparam name="TLocal">The type of the local.</typeparam>
        /// <param name="fromInclusive">The start index, inclusive.</param>
        /// <param name="toExclusive">The end index, exclusive.</param>
            ...
            Action<TLocal> localFinally)
        {
            ...
            return Parallel.ForEach(Partitioner.Create(fromInclusive, toExclusive), parallelOptions, localInit, (range, loopState, x) => body(range.Item1, range.Item2, loopState, x), localFinally);
        }
        #endregion
