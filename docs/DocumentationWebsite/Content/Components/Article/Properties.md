Article component's model exposes the following properties that let you tweak different aspects of the component. The following table lists out the properties: 
