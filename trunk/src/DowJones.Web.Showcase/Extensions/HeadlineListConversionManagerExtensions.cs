...
namespace DowJones.Web.Showcase.Extensions
{
    public static class HeadlineListConversionManagerExtensions
    {
        ...
        public static HeadlineListViewModel PerformSearch(this HeadlineListConversionManager manager, string searchText, ContentSearchMode? searchMode)
        {
        ...
        private static PerformContentSearchRequest GetPerformContentSearchRequest(string searchText)
        {
            ...
            request.StructuredSearch.Query.SearchCollectionCollection.AddRange( Enum.GetValues( typeof( SearchCollection ) ).Cast<SearchCollection>() );
