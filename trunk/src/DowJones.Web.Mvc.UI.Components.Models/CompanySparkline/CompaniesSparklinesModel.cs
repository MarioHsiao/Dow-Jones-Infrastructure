// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompaniesSparklines.cs" company="Dow Jones & Company">
...
namespace DowJones.Web.Mvc.UI.Components.CompanySparkline
{
    ...
    /// The companies sparklines model.
    /// </summary>
    public class CompaniesSparklinesModel : CompositeComponentModel
    {
        private List<CompanySparklineDataResult> data;

        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesSparklinesModel"/> class.
        /// </summary>
        public CompaniesSparklinesModel()
        {
        ...
        /// The companies.
        /// </param>
        public CompaniesSparklinesModel(IEnumerable<string> companies)
        {
