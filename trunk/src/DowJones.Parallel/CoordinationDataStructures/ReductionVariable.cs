...
namespace System.Threading
{
    ...
    public sealed class ReductionVariable<T>
    {
        ...
        private readonly ThreadLocal<StrongBox<T>> threadLocal;
        ...
        {
            threadLocal = new ThreadLocal<StrongBox<T>>(CreateValue);
        }
        ...
        public T Value
        {
            get { return threadLocal.Value.Value; }
            set { threadLocal.Value.Value = value; }
        }
    ...
    {
        private readonly ReductionVariable<T> variable;
        ...
        public T[] Values { get { return variable.Values.ToArray(); } }
    }
}