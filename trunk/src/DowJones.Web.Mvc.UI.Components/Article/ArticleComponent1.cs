...
namespace DowJones.Web.Mvc.UI.Components.Article
{
    ...
    // Last Generated Timestamp: 06/14/2012 10:19 AM
...
WriteLiteral("\">\r\n        \r\n");
         ...
         if(Model != null && Model.VideoPlayerModel != null) 
        {
...
"\r\n                    ");
                ...
                Write(CreateChildControl<VideoPlayerControl>(Model.VideoPlayerModel));
...
WriteLiteral("                        <div class=\"dj_article_by dj_article_section\">\r\n");
                            ...
                            {
                                foreach (var renderItem in Model.ArticleDataSet.Authors)
                                {
...
"         ");
                    ...
                    Write(CreateChildControl<ArticleTranslator.ArticleTranslatorControl>(Model.Translator));
...
WriteLiteral("            <div class=\"dj_article_article_body\">\r\n");
                 ...
                 if (!Model.ArticleDataSet.Correction.IsNullOrEmpty())
                {
                    ...
                    Write(kvc.Key.Equals("pre") ? CreateChildControl<Paragraph>(Model.GetParagraphModel(kvc.Value, "pre", "dj_article_paragraph")) 
