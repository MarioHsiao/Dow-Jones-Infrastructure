...
namespace DowJones.Managers.Charting.MarketData
{
    public class MarketDataManager
    {
        ...
        public static MarketChartDataServiceResult GetMarketChartData( string[] symbols, TimePeriod timePeriod = TimePeriod.OneDay, Frequency frequency = Frequency.FifteenMinutes)
        {
