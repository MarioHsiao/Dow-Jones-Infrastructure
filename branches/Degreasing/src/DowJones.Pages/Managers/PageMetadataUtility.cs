// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PageMetadataUtility.cs" company="Dow Jones">
...
namespace DowJones.Pages.DataAccess.Managers
{
    public static class PageMetadataUtility
    {
        ...
        private static readonly Dictionary<string, List<MetaData>> SymbologyCodes = new Dictionary<string, List<MetaData>>();
        ...
        public static MetaData GetMetaDataMetaData(string code, string language, out List<MetaData> symbologyCodes)
        {
            symbologyCodes = SymbologyCodes.ContainsKey(code) ? SymbologyCodes[code] : null;
            return GetMetaDataMetaData(code, language);
        }
