...
namespace System.Net
{
    ...
    public static class WebRequestExtensions
    {
        ...
        /// <summary>Creates a Task that represents downloading all of the data from a WebRequest.</summary>
        /// <param name="webRequest">The WebRequest.</param>
        ...
        public static Task<byte[]> DownloadDataAsync(this WebRequest webRequest)
        {
            ...
            return webRequest.GetResponseAsync().ContinueWith(response => response.Result.GetResponseStream().ReadAllBytesAsync()).Unwrap();
        }
    }
}