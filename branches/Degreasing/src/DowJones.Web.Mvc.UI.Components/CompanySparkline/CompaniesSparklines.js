 ...
 */
    ...
    DJ.UI.CompaniesSparklines = DJ.UI.CompositeComponent.extend({
    ...
    generatePillDelegate: function (i, dataObj) {
        ...
        if (dataObj.closePrices &&
            ...
            el.append("<div class=\"dj_sparkline CompanySparkline dj_sparkline-name\">" + dataObj.name + "</div>");
        }
    },
...
$.plugin('dj_CompaniesSparklines', DJ.UI.CompaniesSparklines);
