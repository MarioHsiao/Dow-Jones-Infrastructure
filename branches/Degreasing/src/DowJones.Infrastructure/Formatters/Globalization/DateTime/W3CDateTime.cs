...
namespace DowJones.Formatters.Globalization.DateTime
{
    public struct W3CDateTime
    {
        ...
        private readonly System.DateTime _dtime;
        private readonly TimeSpan _ofs;


        public W3CDateTime(System.DateTime dt, TimeSpan off)
        {
            _ofs = off;
            _dtime = dt;
        }
        ...
        public static W3CDateTime Parse(string s)
        {
            ...
            try
            {
                ...
                return new W3CDateTime(new System.DateTime(year, month, day, hour, min, sec, ms) - ofs, ofs);
            }
            catch (Exception ex)
            {
