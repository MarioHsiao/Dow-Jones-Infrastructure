...
using System.IO;
using DowJones.Readers.CSV.Events;
...
namespace DowJones.Readers.CSV
{
    ...
    public partial class CsvReader : IDataReader, IEnumerable<string[]>
    {
                    ...
                    else if (_buffer[_nextFieldStart] != _quote)
                    {
                        ...
                        if (!discardValue)
                        {
                            ...
                            else
                            {
                                ...
                                if (pos <= 0 && !string.IsNullOrEmpty(value))
                                {
                                    pos = value.Length - 1;
        ...
        /// <returns>
        /// The resulting value according to <see cref="MissingFieldAction"/>.
        /// If the action is set to <see cref="MissingFieldAction"/>,
