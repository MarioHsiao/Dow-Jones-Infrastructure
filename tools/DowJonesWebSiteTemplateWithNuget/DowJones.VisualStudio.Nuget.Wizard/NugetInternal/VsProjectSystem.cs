...
{
    public class VsProjectSystem : PhysicalFileSystem, IProjectSystem, IComparer<IPackageFile>
    {
        ...
        public VsProjectSystem(Project project, IFileSystem fileSystemProvider) 
            : base(project.GetFullPath())
        {
            Project = project;
            _baseFileSystem = fileSystemProvider;
        ...
        public override void DeleteDirectory(string path, bool recursive = false)
        {
            ...
            if (!recursive && (this.GetFiles(path, "*.*", recursive).Any() || base.GetDirectories(path).Any()))
            {
