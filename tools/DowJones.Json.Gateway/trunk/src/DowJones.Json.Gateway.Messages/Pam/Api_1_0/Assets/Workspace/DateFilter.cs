...
{
    [JsonObject(Title = "DateFilter")]
    [XmlType(TypeName = "DateFilter", Namespace = Declarations.SchemaVersion), Serializable]
    [EditorBrowsable(EditorBrowsableState.Always)]
    public class DateFilter : Filter
    {
        [JsonProperty(PropertyName = "target")]
        [XmlElement(ElementName = "target", IsNullable = false, Form = XmlSchemaForm.Qualified, Namespace = Declarations.SchemaVersion)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DataMember(Name = "target")]
        public DateFilterTarget __target;

        [JsonIgnore]
        [XmlIgnore]
        [IgnoreDataMember]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public bool __targetSpecified;

        [JsonIgnore]
        [XmlIgnore]
        [IgnoreDataMember]
        public DateFilterTarget Target
        {
            get { return __target; }
            set { __target = value; __targetSpecified = true; }
        }
