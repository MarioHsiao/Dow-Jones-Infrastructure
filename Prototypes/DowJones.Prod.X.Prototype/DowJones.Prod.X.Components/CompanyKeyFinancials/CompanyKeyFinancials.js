/*!
 * CompanyKeyFinancials
 */

    DJ.UI.CompanyKeyFinancials = DJ.UI.Component.extend({

        init: function (element, meta) {
            // Call the base constructor
            this._super(element, $.extend({ name: "CompanyKeyFinancials" }, meta));
    ...
    $.plugin('dj_CompanyKeyFinancials', DJ.UI.CompanyKeyFinancials);
