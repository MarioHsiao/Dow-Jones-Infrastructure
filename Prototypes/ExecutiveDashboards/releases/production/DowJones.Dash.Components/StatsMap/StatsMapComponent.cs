...
namespace DowJones.Dash.Components.StatsMap
{
    ...
    // Last Generated Timestamp: 10/08/2012 03:54 PM
    [DowJones.Web.ScriptResourceAttribute(null, ResourceName="DowJones.Dash.Components.StatsMap.StatsMap.js", DependsOn=new string[] {
            ...
            "us-map-shapes",
            "germany-map-shapes",
            "world-map-shapes"}, ResourceKind=DowJones.Web.ClientResourceKind.Script, DeclaringType=typeof(DowJones.Dash.Components.StatsMap.StatsMapComponent))]
