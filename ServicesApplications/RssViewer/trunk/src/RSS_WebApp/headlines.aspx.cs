    ...
    public partial class headlines : System.Web.UI.Page
    {
        ...
        private bool validate()
        {
            ...
            try
            {
                ...
                //addtional NVP passed from query string
                if (Request.QueryString["app"] != null)
                {
                    rssManager2.inputData.data.Add("app", Request.QueryString["app"]);
                }
        ...
        {
            if (System.Configuration.ConfigurationManager.AppSettings["logging"] == "On" || level >= FactivaRssManager.Logger.Level.ERROR)
