...
namespace EMG.widgets.ui.syndication.integration.alertWidget
{
    ...
    /// 
    /// </summary>
    internal class IGoogleGadget : AbstractWidgetPortalEndPoint
    {
        private const string m_Title = "addToIGoogle";
        private const string m_IconVirtualPath = "~/img/syndication/icons/igoogle.png";
        private const bool m_HasIconImage = true;
        private const string m_BarImageVirtualPath = "~/img/syndication/bar/plus_google.gif";
        private const bool m_HasBarImage = true;
        private const string m_BaseIntegrationUrl = "http://www.google.com/ig/adde";
        private const string m_TemplateFileLocation = "~/syndication/integration/alertwidget/templates/igooglegadget.xml";
        private const MimeType m_MimeType = utility.MimeType.XML;
        private RenderWidgetDTO m_RenderWidgetDTO;

        /// <summary>
        /// Initializes a new instance of the <see cref="IGoogleGadget"/> class.
        /// </summary>
        /// <param name="dto">The dto.</param>
        public IGoogleGadget(RenderWidgetDTO dto)
        {
        ...
        public override string GetIntegrationCode()
        {
            ...
            return string.Format(GetTemplate,
                                 ...
                                 JavascriptResourceManager.GetJsonpDataUrl(m_RenderWidgetDTO, IntegrationTarget.IGoogle),
        ...
        /// <summary>
        /// Generates the IGoogle.com add gadget URL.
        /// </summary>
        /// <returns></returns>
        public override string GetIntegrationUrl()
        {
            string gagetUrl = GetGenericIntegrationUrl(m_RenderWidgetDTO.token, m_RenderWidgetDTO.type, IntegrationTarget.IGoogle);
