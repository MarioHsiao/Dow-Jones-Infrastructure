if (!window.FactivaWidgetRenderManager) {
    FactivaWidgetRenderManager = (function () {
        ...
        function PrivateConstructor() {
            ...
            this.xIsSafari3 = function () {
                if (xUA.indexOf('safari') > 0) {
                    var is_minor = parseFloat(xUA.substring(xUA.indexOf('safari') + 7, xUA.indexOf('safari') + 12));
            ...
            this.xAddEventListener = function (e, eT, eL, cap) {
                if (!(e = this.xGetElementById(e))) return;
                eT = eT.toLowerCase();
            ...
            this.xBackground = function (e, c, i) {
                if (!(e = this.xGetElementById(e))) return '';
                var bg = '';
                if (e.style) {
                    if (this.xStr(c)) {
            ...
            this.xColor = function (e, s) {
                if (!(e = this.xGetElementById(e))) return '';
                var c = '';
                if (e.style && this.xDef(e.style.color)) {
                    if (this.xStr(s)) e.style.color = s;
                    c = e.style.color;
                }
                return c;
            };
            this.xCreateElement = function (sTag) {
            ...
            this.xDisplay = function (e, s) {
                if ((e = this.xGetElementById(e)) && e.style && this.xDef(e.style.display)) {
                    if (this.xStr(s)) {
                        try {
                            e.style.display = s;
                        } catch (ex) {
            ...
            this.xGetComputedStyle = function (oEle, sProp, bInt) {
                var s, p = 'undefined';
            ...
            this.xGetElementById = function (e) {
                if (typeof (e) == 'string') {
            ...
            this.xGetElementsByTagName = function (t, p) {
                var list = null;
                t = t || '*';
                p = p || document;
            ...
            this.xHasPoint = function (e, x, y, t, r, b, l) {
                if (!this.xNum(t)) {
                    t = r = b = l = 0;
                } else if (!this.xNum(r)) {
                    r = b = l = t;
                ...
                var eX = this.xPageX(e),
                    eY = this.xPageY(e);
                return (x >= eX + l && x <= eX + this.xWidth(e) - r && y >= eY + t && y <= eY + this.xHeight(e) - b);
            };
            this.xHeight = function (e, h) {
                if (!(e = this.xGetElementById(e))) return 0;
                if (this.xNum(h)) {
                    if (h < 0) h = 0;
                    else h = Math.round(h);
                } else h = -1;
            ...
            this.xHide = function (e) {
                return this.xVisibility(e, 0);
            };
            this.xLeft = function (e, iX) {
                if (!(e = this.xGetElementById(e))) return 0;
                var css = this.xDef(e.style);
                if (css && this.xStr(e.style.left)) {
                    if (this.xNum(iX)) e.style.left = iX + 'px';
                    else {
                        iX = parseInt(e.style.left);
                        if (isNaN(iX)) iX = this.xGetComputedStyle(e, 'left', 1);
                        if (isNaN(iX)) iX = 0;
                    }
                } else if (css && this.xDef(e.style.pixelLeft)) {
                    if (this.xNum(iX)) e.style.pixelLeft = iX;
                    else iX = e.style.pixelLeft;
                }
                return iX;
            };
            this.xMoveTo = function (e, x, y) {
                this.xLeft(e, x);
                this.xTop(e, y);
            };
            this.xNum = function () {
            ...
            this.xOffsetLeft = function (e) {
                if (!(e = this.xGetElementById(e))) return 0;
                if (this.xDef(e.offsetLeft)) return e.offsetLeft;
                else return 0;
            };
            this.xOffsetTop = function (e) {
                if (!(e = this.xGetElementById(e))) return 0;
                if (xDef(e.offsetTop)) return e.offsetTop;
                else return 0;
            };
            this.xOpacity = function (e, o) {
                var set = this.xDef(o);
                if (!(e = this.xGetElementById(e))) return 2;
                if (this.xStr(e.style.opacity)) {
                    if (set) e.style.opacity = o + '';
                    else o = parseFloat(e.style.opacity);
                } else if (this.xStr(e.style.filter)) {
                    if (set) e.style.filter = 'alpha(opacity=' + (100 * o) + ')';
                    else if (e.filters && e.filters.alpha) {
                        o = e.filters.alpha.opacity / 100;
                    }
                } else if (this.xStr(e.style.MozOpacity)) {
                    if (set) e.style.MozOpacity = o + '';
                    else o = parseFloat(e.style.MozOpacity);
                } else if (this.xStr(e.style.KhtmlOpacity)) {
                    if (set) e.style.KhtmlOpacity = o + '';
                    else o = parseFloat(e.style.KhtmlOpacity);
                }
                return isNaN(o) ? 1 : o;
            };
            this.xPageX = function (e) {
                if (!(e = this.xGetElementById(e))) return 0;
                var x = 0;
                while (e) {
            ...
            this.xParent = function (e, bNode) {
                if (!(e = this.xGetElementById(e))) return null;
                var p = null;
            ...
            this.xParentNode = function (ele, n) {
                while (ele && n--) {
                    ele = ele.parentNode;
                }
                return ele;
            };
            this.xRemoveEventListener = function (e, eT, eL, cap) {
                if (!(e = this.xGetElementById(e))) return;
                eT = eT.toLowerCase();
            ...
            this.xResizeTo = function (e, w, h) {
                this.xWidth(e, w);
                this.xHeight(e, h);
            };
            this.xScrollLeft = function (e, bWin) {
                var offset = 0;
                if (!this.xDef(e) || bWin || e == document || e.tagName.toLowerCase() == 'html' || e.tagName.toLowerCase() == 'body') {
                    var w = window;
                    if (bWin && e) w = e;
                    if (w.document.documentElement && w.document.documentElement.scrollLeft) offset = w.document.documentElement.scrollLeft;
                    else if (w.document.body && this.xDef(w.document.body.scrollLeft)) offset = w.document.body.scrollLeft;
                } else {
                    e = this.xGetElementById(e);
                    if (e && this.xNum(e.scrollLeft)) offset = e.scrollLeft;
                }
                return offset;
            };
            this.xScrollTop = function (e, bWin) {
                var offset = 0;
                if (!this.xDef(e) || bWin || e == document || e.tagName
                    .toLowerCase() == 'html' || e.tagName.toLowerCase() == 'body') {
                    var w = window;
                    if (bWin && e) w = e;
                    if (w.document.documentElement && w.document.documentElement.scrollTop) offset = w.document.documentElement.scrollTop;
                    else if (w.document.body && this.xDef(w.document.body.scrollTop)) offset = w.document.body.scrollTop;
                } else {
                    e = this.xGetElementById(e);
                    if (e && this.xNum(e.scrollTop)) offset = e.scrollTop;
                }
                return offset;
            };
            this.xShow = function (e) {
                return this.xVisibility(e, 1);
            };
            this.xStr = function (s) {
                for (var i = 0; i < arguments.length; ++i) {
                    if (typeof (arguments[i]) != 'string') return false;
                }
                return true;
            };
            this.xTabPanelGroup = function (id, w, h, th, clsTP, clsTG, clsTD, clsTS, index) {
                function onClick() {
                    paint(this);
                    return false;
                }
                ...
                this.onResize = function (newW, newH) {
                    ...
                    } else w = this.xWidth(panelGrp); if (newH) {
                        h = newH;
                    ...
                    for (i = 0; i < tabs.length; i++) {
                        ...
                        if (tw <= this.xWidth(tabs[i])) {
                            ...
                            if (xUA.indexOf('mozilla') != -1 && xUA.indexOf('msie') == -1 && typeof (_IG_AdjustIFrameHeight) != "undefined") this.xResizeTo(tabs[i], tabs[i].clientWidth, th + 2);
                            else this.xResizeTo(tabs[i], this.xWidth(tabs[i]), th);
                        } else {
                    ...
                    if (sum > w) {
                        ...
                        if (outerTabContainer != null) {
                            ...
                            if (!xIE6) this.xLeft(outerTabContainer, 0);
                            else outerTabContainer.style.display = "inline";
                        }
                        ...
                        if (xUA.indexOf('mozilla') != -1) var gutterWidth = (this.xWidth(outerTabContainer) - sum) / 2;
                        else var gutterWidth = (this.xWidth(outerTabContainer) - sum) / 4; if (leftTab != null) {
                        ...
                        if (outerTabContainer != null) {
                            ...
                            else this.xLeft(outerTabContainer, gutterWidth); if (typeof (_IG_AdjustIFrameHeight) == "function") this.xLeft(outerTabContainer, gutterWidth);
                        }
                ...
                if (!panels || !tabs || !tabGrp || panels.length != tabs.length || tabGrp.length != 1) {
                    return null;
                }
                selectedIndex = 0;
                if (!FactivaWidgetRenderManager.getInstance().xTabPanelGroup.instances[id].addedListener) {
                    this.xAddEventListener(window, 'resize', function () {
                        ...
                        if (FactivaWidgetRenderManager.getInstance().xWidth(cDiv) > FactivaWidgetRenderManager.getInstance().xWidth(tabGrp[0])) {
                            ...
                            rightBtn.onclick = function () {
                                FactivaWidgetRenderManager.getInstance().moveLeftTab(index);
                                return false;
                            };
                ...
                this.onResize(w, h);
                this.xAddEventListener(window, 'unload', function winUnload() {
            ...
            this.xTop = function (e, iY) {
                if (!(e = this.xGetElementById(e))) return 0;
                var css = this.xDef(e.style);
                if (css && this.xStr(e.style.top)) {
                    if (this.xNum(iY)) e.style.top = iY + 'px';
                    else {
                        iY = parseInt(e.style.top);
                        if (isNaN(iY)) iY = this.xGetComputedStyle(e, 'top', 1);
                        if (isNaN(iY)) iY = 0;
                    }
                } else if (css && this.xDef(e.style.pixelTop)) {
                    if (this.xNum(iY)) e.style.pixelTop = iY;
                    else iY = e.style.pixelTop;
                }
                return iY;
            };
            this.xVisibility = function (e, bShow) {
                if (!(e = this.xGetElementById(e))) return null;
                if (e.style && this.xDef(e.style.visibility)) {
                    if (this.xDef(bShow)) e.style.visibility = bShow ? 'visible' : 'hidden';
                    return e.style.visibility;
                }
                return null;
            };
            this.xWidth = function (e, w) {
                if (!(e = this.xGetElementById(e))) return 0;
                if (this.xNum(w)) {
                    if (w < 0) w = 0;
                    else w = Math.round(w);
            ...
            this.xZIndex = function (e, uZ) {
                if (!(e = this.xGetElementById(e))) return 0;
                if (e.style && this.xDef(e.style.zIndex)) {
                    if (this.xNum(uZ)) e.style.zIndex = uZ;
            ...
            this.xGetElementsByClassName = function (c, p, t, f) {
                ...
                var list = this.xGetElementsByTagName(t, p);
            ...
            this.xInnerHtml = function (e, h) {
                if (!(e = this.xGetElementById(e)) || !this.xStr(e.innerHTML)) return null;
                var s = e.innerHTML;
                if (this.xStr(h)) {
                    e.innerHTML = h;
                }
            ...
            this.xNextSib = function (e, t) {
                if (!(e = this.xGetElementById(e))) return;
                var s = e ? e.nextSibling : null;
                if (t) while (s && s.nodeName.toLowerCase() != t.toLowerCase()) {
                    s = s.nextSibling;
            ...
            this.xWalkEleTree = function (n, f, d, l, b) {
                ...
                if (v == 1) {
                    for (var c = n.firstChild; c; c = c.nextSibling) {
                        if (c.nodeType == 1) {
                            if (!l)+ +b;
                            if (!this.xWalkEleTree(c, f, d, l + 1, b)) return 0;
                        }
                    }
                }
                return 1;
            };
            this.xWalkTree = function (n, f) {
                f(n);
                for (var c = n.firstChild; c; c = c.nextSibling) {
                    if (c.nodeType == 1) this.xWalkTree(c, f);
                }
            };
            this.xGetElementsByName = function (name, parentEle, tagName, fn) {
                var found = [];
                var re = new RegExp('\\b' + name + '\\b', 'i');
                var list = this.xGetElementsByTagName(tagName, parentEle);
                for (var i = 0; i < list.length; ++i) {
                    if (list[i].name.search(re) != -1) {
                        found[found.length] = list[i];
                        if (fn) fn(list[i]);
                    }
                }
            ...
            this.xRemoveChild = function (oParent, oChild) {
                if (oParent.removeChild) return oParent.removeChild(oChild);
                else return null;
            };
            this.xInsertBefore = function (oParent, oNode, oChild) {
                if (oParent.insertBefore) return oParent.insertBefore(oNode, oChild);
            };
            this.xCloneNode = function (oNode) {
                if (oNode.cloneNode) return oNode.cloneNode(true);
                else return null;
            };
            this.xCloneLightNode = function (oNode) {
                if (oNode.cloneNode) return oNode.cloneNode(false);
                else return null;
            };
            this.xRemoveChildren = function (oNode) {
                if (typeof (oNode) != 'undefined' && oNode != null) {
                    return;
                }
                var len = oNode.childNodes.length;
                while (oNode.hasChildNodes()) {
                    this.xRemoveChild(oNode, oNode.firstChild);
                }
            };
            this.xParentElement = function (node, tagName, className) {
                for (; node != null; node = node.parentNode) {
                    if (className && className.length > 0) {
                        if (node.nodeType == 1 && node.nodeName.toUpperCase() == tagName.toUpperCase() && (node.className == className || node.id == className)) return node;
                    } else if (node.nodeType == 1 && node.nodeName.toUpperCase() == tagName.toUpperCase()) return node;
                }
                return null;
            };
            this.xFindChildNode = function (nodeObj, tn, cn) {
                cn = (cn) ? CStr(cn) : "";
                for (var i = 0; i < nodeObj.childNodes.length; i++) {
                    switch (nodeObj.childNodes[i].nodeType) {
                        case 1:
                            tVal = null;
                            if (nodeObj.childNodes[i].tagName == tn.toUpperCase() && (nodeObj.childNodes[i].className == cn || nodeObj.childNodes[i].id == cn)) {
            ...
            this.xInnerText = function (oNode) {
            ...
            var xChildWindow = [];
            this.xWinOpen = function (sUrl, w, h, winName) {
                var winWidth = 800;
                var winHeight = 600;
                if (w && w != null) winWidth = w;
                if (h && h != null) winHeight = h;
                if (!winName) {
                    winName = "_factivaWidgetArticleWindow";
                }
                var features = "left=0,top=0,width=" + winWidth + ",height=" + winHeight + ",location=0,menubar=1,resizable=1,scrollbars=1,status=1,toolbar=0";
                if (xChildWindow[winName] && !xChildWindow[winName].closed) {
                    xChildWindow[winName].location.href = sUrl;
                    try {
                        xChildWindow[winName].resizeTo(winWidth, winHeight);
                    } catch (e) { }
                } else {
                    xChildWindow[winName] = window.open(sUrl, winName, features);
                    try {
                        xChildWindow[winName].resizeTo(winWidth, winHeight);
                    } catch (e) { }
                }
                try {
                    xChildWindow[winName].focus();
                } catch (e) { }
                return false;
            };
            ...
            com.deconcept.FlashObject.prototype = {
                ...
                getVariablePairs: function () {
                    ...
                    for (key in variables) {
                        if (key != "extend") variablePairs.push(key + "=" + variables[key]);
                    }
                ...
                getFlashHTML: function () {
                    ...
                    if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
                        ...
                        for (var key in params) {
                            if (key != "extend") flashNode += [key] + '="' + params[key] + '" ';
                        }
                        ...
                        var params = this.getParams();
                        for (var key in params) {
                            if (key != "extend") flashNode += '<param name="' + key + '" value="' + params[key] + '" />';
                        }
                        var pairs = this.getVariablePairs().join("&");
                        if (pairs.length > 0) {
            ...
            this.xBuildManualNewsletterWorkspaceWidget = function (tEle, result, showTitle, integrateFontCSS) {
                ...
                if (result != null && result.Definition != null) {
                    ...
                    var titleFontSize = (typeof (integrateFontCSS) === 'boolean' && integrateFontCSS == true) ? "larger" : _fontSizes[result.Definition.FontSize].t
                    itleFontSize + "px";
                    var showSnippet = (result.Definition.DisplayType == 1);
                    sb[sb.length] = "<div id=\"scriptPreview\"  style=\"" + this.getOuterContainerStyle(bgColor, fontFamily, contentFontSize, mColor, contentColor) + "\">";
                    if (showTitle) {
                        sb[sb.length] = this.getWidgetTitle(widgetName, mColor, titleFontSize, mFontColor, fontFamily, (result.Literals) ? result.Literals.Icon : null);
                        sb[sb.length] = "<div id=\"fctv_border\"  style=\"" + this.getBorderStyle(bgColor, fontFamily, contentFontSize, mColor, contentColor) + "\">";
                    }
                    ...
                    if (result.Data != null && result.Data.ManualNewsletterWorkspaceInfo != null) {
                        if (result.Data.ManualNewsletterWorkspaceInfo.Count > 0) {
                            for (var i = 0; i < result.Data.ManualNewsletterWorkspaceInfo.Count; i++) {
                                sb[sb.length] = this.getSectionTitle(result.Data.ManualNewsletterWorkspaceInfo.Sections[i], aColor, titleFontSize, aFontColor, fontFamily);
                                ...
                                sb[sb.length] = "<div id=\"" + _curDivCntrId + "\" class=\"fctv_MnlWrkSpcHeadlineCont\" style=\"" + this.getInnerContainerStyle(bgColor, fontFamily, contentFontSize, contentColor) + "\">";
                                if (_count > numHeadlines) {
                                    sb[sb.length] = this.getPagingBar(numHeadlines, _count, result.Literals, "#e5e5e0", contentFontSize, "#333333", fontFamily, _curDivCntrId);
                                }
                                for (var j = 0; j < _count; j++) {
                                    var showHeadline = (j < numHeadlines);
                                    var _headline = _headlines[j];
                                    sb[sb.length] = this.getHeadline(bgColor, fontFamily, contentFontSize, contentColor, auxInfoColor, snippetColor, _headline, showHeadline, showSnippet, result.Literals);
                                }
                                if (_count > numHeadlines && numHeadlines > 1) {
                                    sb[sb.length] = this.getPagingBar(numHeadlines, _count, result.Literals, "#e5e5e0", contentFontSize, "#333333", fontFamily, _curDivCntrId);
                                }
                                if (result.Data.ManualNewsletterWorkspaceInfo.Sections[i].Type == "Sub") sb[sb.length] = "</div></div>";
                                else sb[sb.length] = "</div>";
                            }
                        } else if (result.Literals != null && result.Literals.NoResults != null) {
                            sb[sb.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                        }
                    }
                    if (showTitle) {
                        sb[sb.length] = "</div>";
                    ...
                    if (result.Literals != null && result.Literals.CopyRight != null) {
                        sb[sb.length] = this.getCopyRightPanel(metaRandomnumber, mColor, _fontFamilies[0], _fontSizes[1].contentFontSize + "px", contentColor, result.Literals.CopyRight, result.Literals.BrandingBadge, result.Literals.MarketingSiteUrl, result.Literals.MarketingSiteTitle, showTitle);
                    }
                    sb[sb.length] = "</div>";
                ...
                if (result != null && result.Definition != null) {
                    ...
                    if (result.Data != null && result.Data.AutomaticWorkspaceInfo != null) {
                        if (result.Data.AutomaticWorkspaceInfo.Count > 0) {
                            ...
                            sb[sb.length] = "<div id=\"" + _curDivCntrId + "\" class=\"fctv_AutoWrkSpcHeadlineCont\" style=\"" + this.getInnerContainerStyle(bgColor, fontFamily, contentFontSize, contentColor) + "\">";
                            if (_count > numHeadlines) {
                                sb[sb.length] = this.getPagingBar(numHeadlines, _count, result.Literals, "#e5e5e0", contentFontSize, "#333333", fontFamily, _curDivCntrId);
                            }
                            for (var j = 0; j < _count; j++) {
            ...
            this.xBuildAlertWidget = function (tEle, result, showTitle, integrateFontCSS) {
                ...
                if (result != null && result.Definition != null) {
                    ...
                    var titleFontSize = (typeof (integrateFontCSS) === 'boolean' && integrateFontCSS == true) ? "larger" : _fontSizes[result.Definition.FontSize].titleFontSize + "px";
                    var showSnippet = (result.Definition.DisplayType == 1);
                    this.appendTabStyles(tEle, (showTitle) ? mColor : "#FFFFFF", mColor, showTitle, aColor, bgColor, (result.Literals) ? result.Literals.CarouselLeft : null, (result.Literals) ? result.Literals.CarouselRight : null);
                    sb[sb.length] = "<div id=\"scriptPreview\" style=\"" + this.getOuterContainerStyle(bgColor, fontFamily, contentFontSize, (showTitle) ? mColor : "#FFFFFF", contentColor) + "\">";
                    if (showTitle) {
                        sb[sb.length] = this.getWidgetTitle(widgetName, mColor, titleFontSize, mFontColor, fontFamily, (result.Literals) ? result.Literals.Icon : null);
                    }
                        ...
                        for (var i = 0; i < discoveryTabs.length; i++) {
                            ...
                            if (currentTab.Active == true) {
                                if (currentTab.Id == "headlines") {
                                    sb[sb.length] = this.getAlertHeadlinesPanel(tEle, result, showTitle, integrateFontCSS);
                                }
                                if (currentTab.Id == "companies") {
                                    sb[sb.length] = this.getAlertCompaniesPanel(tEle, result, showTitle, integrateFontCSS);
                                }
                                if (currentTab.Id == "subjects") {
                                    sb[sb.length] = this.getAlertSubjectsPanel(tEle, result, showTitle, integrateFontCSS);
                                }
                                if (currentTab.Id == "industries") {
                                    sb[sb.length] = this.getAlertIndustriesPanel(tEle, result, showTitle, integrateFontCSS);
                                }
                                if (currentTab.Id == "executives") {
                                    sb[sb.length] = this.getAlertExecutivesPanel(tEle, result, showTitle, integrateFontCSS);
                                }
                                if (currentTab.Id == "regions") {
                                    sb[sb.length] = this.getAlertRegionsPanel(tEle, result, showTitle, integrateFontCSS);
                                }
                            }
                        }
                        sb[sb.length] = "</div>";
            ...
            this.getCopyRightPanel = function (metaRandomnumber, bgColor, fontFamily, fontSize, fontColor, token, badge, marketingUrl, title, showTitle) {
                var t = [];
                t[t.length] = "<div id=\"fctv_copyRight\" style=\"" + ";padding:3px 5px" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal" + ";zoom:1" + ";background-color:#FFF;" + ";overflow:hidden;";
                if (showTitle) {
                    t[t.length] = ";border-left: solid 1px " + bgColor + ";border-right: solid 1px " + bgColor;
                }
                t[t.length] = "\">";
                if (badge) {
                    ...
                    t[t.length] = "<div id=\"fctv_copyRight\" style=\"" + ";padding-bottom:2px" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal;" + "\">";
                ...
                if (showTitle) {
                    ...
                    t[t.length] = "<b style=\"" + "background-color: #FFF;" + ";border-left: solid 1px " + bgColor + ";border-right: solid 1px " + bgColor + ";margin:0 1px" + ";line-height:1px;height:2px;overflow:hidden;display:block;" + "\"></b>";
                    t[t.length] = "<b style=\"" + "background-color: #FFF;" + ";border-left: solid 2px " + bgColor + ";border-right: solid 2px " + bgColor + ";margin:0 2px" + ";line-height:1px;height:1px;overflow:hidden;display:block;" + "\"></b>";
                    t[t.length] = "<b style=\"" + "background-color:" + bgColor + ";border-left: solid 1px " + bgColor + ";border-right: solid 1px " + bgColor + ";margin:0 4px" + ";line-height:1px;height:1px;overflow:hidden;display:block;" + "\"></b>";
                    t[t.length] = "</b>";
                }
                return t.join("");
            };
            ...
            this.getNoResultsPanel = function (bgColor, fontFamily, fontSize, fontColor, token) {
                return "<div id=\"fctv_headline\" style=\"" + "background-color:" + bgColor + ";padding:3px 5px" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal" + "\">" + token + "</div>";
            };
            this.getHeadline = function (bgColor, fontFamily, fontSize, fontColor, auxInfoColor, snippetColor, headline, showHeadline, showSnippet, literals) {
                ...
                sb[sb.length] = "<div id=\"fctv_headline\" style=\"" + ";padding:3px 5px" + ";margin-left:15px" + ";padding-bottom:0" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal\">";
                ...
                sb[sb.length] = ((!(xSfr3 && xMac)) ? "<a class=\"factivaLink\" href=\"" + headline.Url + "\" target=\"_new\" onclick=\"try{if(FactivaWidgetRenderManager && FactivaWidgetRenderManager.getInstance()) {FactivaWidgetRenderManager.getInstance().xWinOpen(this.href);return false;}}catch(e){return true;}\" style=\"font-weight:bold;color:" + fontColor + ";text-decoration:none;\" onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\" onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\" title=\"" : "\"><a class=\"factivaLink\" href=\"" + headline.Url + "\" target=\"_new\" style=\"font-weight:bold;color:" + fontColor + ";text-decoration:none;\" onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\" onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\" title=\"") + ((!showSnippet) ? headline.Snippet.replace("\"", "&quot;") : headline.Text.replace("\"", "&quot;")) + "\">" + ((headline.TruncText != null && headline.TruncText.length > 0) ? headline.TruncText : headline.Text) + "</a></div>";
                var t = [];
                ...
                if (t.length > 0) {
                    sb[sb.length] = "<div id=\"fctv_auxInfo\" style=\"" + ";padding:3px 5px" + ";padding-top:2px" + ";margin-left:15px;" + ";padding-bottom:0" + ";color:" + auxInfoColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal" + "\">";
                    sb[sb.length] = t.join("");
                    sb[sb.length] = "</div>";
                }
                if (showSnippet) {
                    sb[sb.length] = "<div id=\"fctv_snippet\" style=\"" + ";padding:3px 5px" + ";padding-top:2px" + ";margin-left:15px;" + ";color:" + snippetColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal" + "\">" + headline.Snippet + "</div>";
                }
                if (this.xStr(headline.Comment) && headline.Comment != null && headline.Comment.length > 0) {
                    sb[sb.length] = "<div id=\"fctv_comment\" style=\"" + ";padding:3px 5px" + ";padding-top:2px" + ";margin-left:15px;" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal" + "\">" + headline.Comment + "</div>";
                }
                sb[sb.length] = "</div>";
                sb[sb.length] = "</div>";
                return sb.join("");
            ...
            this.getOuterContainerStyle = function (bgColor, fontFamily, fontSize, borderColor, fontColor) {
                return "background-color:" + bgColor + ";font-family:" + fontFamily + ";font-size:" + fontSize + ";color:" + fontColor + ";font-weight:normal" + ";";
            };
            this.getBorderStyle = function (bgColor, fontFamily, fontSize, borderColor, fontColor) {
                return "background-color:" + bgColor + ";font-family:" + fontFamily + ";font-size:12" + ";color:" + fontColor + ";font-weight:normal" + ";border-left:solid 1px " + borderColor + ";border-right:solid 1px " + borderColor + ";zoom:1;";
            };
            this.getTabPanelGroup = function (mColor, _literals, _discoveryTabs, activeCount) {
                ...
                t[t.length] = (activeCount != 1) ? "<div style=\"display:block;padding-bottom:10px;position:relative;zoom:1;\" >" : "<div style=\"position:absolute;height:0px;left:0px;top:0px;width:0px;\" >";
            ...
            this.getTabPanels = function (_literals, _discoveryTabs) {
                var t = [];
                t[t.length] = "<div id=\"fctv_tabLeft" + this.getIndex() + "\" class=\"tabLeft\" " + " onclick=\"FactivaWidgetRenderManager.getInstance().moveRightTab(" + this.getIndex() + ");return false;\"></div>";
                ...
                for (var i = 0; i < _discoveryTabs.length; i++) {
                    ...
                    if (currentTab.Active == true) {
                        if (currentTab.Id == "headlines") t[t.length] = "<a id=\"" + currentTab.Id + "_tab\" href=\"javascript:void(0)\" style=\"outline:none;\" title=\"" + _literals.Headlines + "\" class=\"tabDefault\">&nbsp;&nbsp;" + _literals.Headlines + "&nbsp;&nbsp;</a>";
                        if (currentTab.Id == "companies") t[t.length] = "<a id=\"" + currentTab.Id + "_tab\" href=\"javascript:void(0)\" style=\"outline:none;\" title=\"" + _literals.Companies + "\" class=\"tabDefault\">&nbsp;&nbsp;" + _literals.Companies + "&nbsp;&nbsp;</a>";
                        if (currentTab.Id == "subjects") t[t.length] = "<a id=\"" + currentTab.Id + "_tab\" href=\"javascript:void(0)\" style=\"outline:none;\" title=\"" + _literals.Subjects + "\" class=\"tabDefault\">&nbsp;&nbsp;" + _literals.Subjects + "&nbsp;&nbsp;</a>";
                        if (currentTab.Id == "industries") t[t.length] = "<a id=\"" + currentTab.Id + "_tab\" href=\"javascript:void(0)\" style=\"outline:none;\" title=\"" + _literals.Industries + "\" class=\"tabDefault\">&nbsp;&nbsp;" + _literals.Industries + "&nbsp;&nbsp;</a>";
                        if (currentTab.Id == "executives") t[t.length] = "<a id=\"" + currentTab.Id + "_tab\" href=\"javascript:void(0)\" style=\"outline:none;\" title=\"" + _literals.Executives + "\" class=\"tabDefault\">&nbsp;&nbsp;" + _literals.Executives + "&nbsp;&nbsp;</a>";
                        if (currentTab.Id == "regions") t[t.length] = "<a id=\"" + currentTab.Id + "_tab\" href=\"javascript:void(0)\" style=\"outline:none;\" title=\"" + _literals.Regions + "\" class=\"tabDefault\">&nbsp;&nbsp;" + _literals.Regions + "&nbsp;&nbsp;</a>";
                    }
                }
                t[t.length] = "&nbsp;</div>";
                t[t.length] = "</div>";
                t[t.length] = "<div id=\"fctv_tabRight" + this.getIndex() + "\" class=\"tabRight\" " + " onclick=\"FactivaWidgetRenderManager.getInstance().moveLeftTab(" + this.getIndex() + ");return false;\"></div>";
                return t.join("");
            };
            this.appendTabStyles = function (tEle, mColor, tabmColor, showTitle, aColor, bgColor, leftCarouselIcon, rightCarouselIcon) {
                ...
                var tabStyles = "#" + this.xGetElementById(tEle).id + " .tabPanelGroup{overflow:hidden;zoom:1" + ";border-left:1px solid " + mColor + ";border-right:1px solid " + mColor + ";} " + "#" + this.xGetElementById(tEle).id + " .tabPanel{display:inline-block;overflow:hidden;position:relative;width:100%;}" + "#" + this.xGetElementById(tEle).id + " .tabGroupOuterContainer{display:inline-block;margin-bottom:0px;overflow:hidden;position:relative;width:100%;}" + "#" + this.xGetElementById(tEle).id + " .tabLeft{" + "background: url(" + leftCarouselIcon + ") no-repeat center center" + ";background-color: #DDDDDD" + ";border:1px solid " + tabmColor + ";border-top: " + (showTitle ? "none" : "1px solid " + tabmColor) + ";cursor:pointer" + ";display:none" + ";left:0px" + ";outline:none" + ";position:absolute" + ";width:20px" + ";top:0px" + ";visibility:hidden" + ";} " + "#" + this.xGetElementById(tEle).id + " .tabLeftGutter{" + "border-bottom:1px solid " + tabmColor + ";background-color:#FFFFFF" + ";filter:alpha(opacity=65)" + ";opacity:0.65" + ";outline:none" + ";left:0px" + ";position:absolute" + ";top:0px" + ";} " + "#" + this.xGetElementById(tEle).id + " .tabRight{" + "background: url(" + rightCarouselIcon + ") no-repeat center center" + ";border:1px solid " + tabmColor + ";border-top: " + (showTitle ? "none" : "1px solid " + tabmColor) + ";cursor:pointer" + ";display:none" + ";right:0px" + ";outline:none" + ";position:absolute" + ";width:20px" + ";top:0px" + ";visibility:hidden" + ";} " + "#" + this.xGetElementById(tEle).id + " .tabRightGutter{" + "border-bottom:1px solid " + tabmColor + ";background-color:#FFFFFF" + ";filter:alpha(opacity=65)" + ";opacity:0.65" + ";outline:none" + ";right:0px" + ";position:absolute" + ";top:0px" + ";} " + "#" + this.xGetElementById(tEle).id + " .tabGroup{display:block;margin:0 auto;overflow:hidden;position:relative;}" + "#" + this.xGetElementById(tEle).id + " .tabGroup a.tabDefault:link" + ", #" + this.xGetElementById(tEle).id + " .tabGroup a.tabDefault:visited" + ", #" + this.xGetElementById(tEle).id + " .tabGroup a.tabDefault:active" + ", #" + this.xGetElementById(tEle).id + " .tabDefault{background:" + aColor + " none repeat scroll 0 0" + ";border:1px solid " + tabmColor + ";border-top: " + (showTitle ? "none" : "1px solid " + tabmColor) + ";color:" + (hsl[2] > 0.5 ? "#000" : "#fff") + ";cursor:pointer" + ";display:inline-block" + ";filter:alpha(opacity=65)" + ";font-weight:bold" + ";opacity:0.65" + ";padding-top:5px" + ";text-align:center" + ";text-decoration:none" + ";zoom:1" + ";} " + "#" + this.xGetElementById(tEle).id + " .tabGroup a.tabDefault:hover" + ", #" + this.xGetElementById(tEle).id + " .tabDefault:hover{background:" + bgColor + " none repeat scroll 0 0" + ";border:1px solid " + tabmColor + ";border-top: " + (showTitle ? "none" : "1px solid " + tabmColor) + ";border-bottom:1px solid white" + ";color: #333" + ";cursor:pointer" + ";display:inline-block" + ";filter:alpha(opacity=100)" + ";font-weight:bold" + ";opacity:1.0" + ";padding-top:5px" + ";text-align:center" + ";text-decoration:none" + ";zoom:1" + ";} " + "#" + this.xGetElementById(tEle).id + " .tabGroup a.tabSelected:link" + ", #" + this.xGetElementById(tEle).id + " .tabGroup a.tabSelected:visited" + ", #" + this.xGetElementById(tEle).id + " .tabGroup a.tabSelected:active" + ", #" + this.xGetElementById(tEle).id + " .tabGroup a.tabSelected:hover" + ", #" + this.xGetElementById(tEle).id + " .tabSelected{background:" + bgColor + " none repeat scroll 0 0" + ";border-left:1px solid " + tabmColor + ";border-right:1px solid " + tabmColor + ";border-top: " + (showTitle ? "none" : "1px solid " + tabmColor) + ";border-bottom:1px solid white" + ";color:#000" + ";cursor:pointer" + ";display:inline-block" + ";font-weight:bold" + ";padding-top:5px" + ";text-align:center" + ";text-decoration:none" + ";zoom:1" + ";} ";
                ...
                if (result.Data != null && result.Data.Count > 0) {
                    for (var i = 0; i < result.Data.Count; i++) {
                        ...
                        if (_alert.Status.Code == 0) {
                            t[t.length] = this.getAlertTitle(_alert, result.Literals, aColor, titleFontSize, aFontColor, fontFamily);
                            if (_alert.HeadlineCount > 0) {
                                var randomnumber = Math.floor(Math.random() * 100001);
                                var _curDivCntrId = "folder_" + _alert.Id + "_" + randomnumber;
                                t[t.length] = "<div id=\"" + _curDivCntrId + "\" class=\"fctv_AlertHeadlineCont\" style=\"" + this.getInnerContainerStyle(bgColor, fontFamily, contentFontSize, contentColor) + "\">";
                                if (_alert.HeadlineCount > numHeadlines && numHeadlines != 0) {
                                    t[t.length] = this.getPagingBar(numHeadlines, _alert.HeadlineCount, result.Literals, "#e5e5e0", contentFontSize, "#333333", fontFamily, _curDivCntrId, _alert);
                                }
                                for (var j = 0; j < _alert.HeadlineCount; j++) {
                                    var showHeadline = (j < numHeadlines);
                                    var _headline = _alert.Headlines[j];
                                    t[t.length] = this.getHeadline(bgColor, fontFamily, contentFontSize, contentColor, auxInfoColor, snippetColor, _headline, showHeadline, showSnippet, result.Literals);
                                }
                                ...
                                t[t.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                            }
                        }
                    }
                }
            ...
            this.addDiscoveryChart = function (chartdata, chartimage) {
                if (chartdata != null && chartdata.data.length > 0) {
                    ...
                    t[t.length] = "<div id=\"discoveryChart\" class=\"cd_cont discovery-wrapper\"style=\"margin:10px auto 10px auto" + ";position:relative" + ";text-align:center" + ";font-size: 11px;" + ";padding-bottom: 5px;" + "border-bottom: 1px solid #f0f0f0;" + "width:211px;" + ";\">" + htmldata + "</div>";
                    return t.join("");
                }
            };
            this.addGetThisAlertUrl = function (url, token, mColor) {
                if (url != null) {
                    ...
                    t[t.length] = ((!(xSfr3 && xMac)) ? "<a id=\"getAlert\" href=\"" + url + "\"" + " onclick=\"if(FactivaWidgetRenderManager && FactivaWidgetRenderManager.getInstance()) {FactivaWidgetRenderManager.getInstance().xWinOpen(this.href);return false;}\" title=\"" + token + "\"" + " onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\"" + " onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\"" + " style=\"color:" + mColor + ";font-size:10px" + ";font-weight:normal" + ";margin:5px" + ";outline:none" + ";position:relative" + ";text-decoration:none;\">" + token + "</a>" : "<a id=\"getAlert\" href=\"" + url + "\" target=\"_new\" title=\"" + token + "\"" + " onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\"" + " onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\"" + " style=\"color:" + mColor + ";font-size:10px" + ";font-weight:normal" + ";margin:5px" + ";outline:none" + ";position:relative" + ";text-decoration:none;\">" + token + "</a>");
                    t[t.length] = "</div>";
                    return t.join("");
                }
            };
                        ...
                        if (_alert.Status.Code == 0) {
                            ...
                            if (_alert.CompaniesChart != null) {
                                ...
                                if (result.Data.Alerts[i].IsGroupFolder == false) {
                                    if (result.Definition.DistributionType == 0 || result.Definition.DistributionType == 1) t[t.length] = this.addGetThisAlertUrl(_alert.CompaniesChart.GetThisAlertUrl, result.Literals.GetThisAlert, mColor);
                                }
                            } else if (result.Literals != null && result.Literals.NoResults != null) {
                                t[t.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                            }
                    ...
                    for (var i = 0; i < result.Data.Count; i++) {
                        ...
                        if (_alert.Status.Code == 0) {
                            ...
                            if (_alert.SubjectsChart != null) {
                                ...
                                if (result.Data.Alerts[i].IsGroupFolder == false) {
                                    if (result.Definition.DistributionType == 0 || result.Definition.DistributionType == 1) t[t.length] = this.addGetThisAlertUrl(_alert.SubjectsChart.GetThisAlertUrl, result.Literals.GetThisAlert, mColor);
                                }
                            } else if (result.Literals != null && result.Literals.NoResults != null) {
                                t[t.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                            }
                    ...
                    for (var i = 0; i < result.Data.Count; i++) {
                        ...
                        if (_alert.Status.Code == 0) {
                            ...
                            if (_alert.IndustriesChart != null) {
                                ...
                                if (result.Data.Alerts[i].IsGroupFolder == false) {
                                    if (result.Definition.DistributionType == 0 || result.Definition.DistributionType == 1) t[t.length] = this.addGetThisAlertUrl(_alert.IndustriesChart.GetThisAlertUrl, result.Literals.GetThisAlert, mColor);
                                }
                            } else if (result.Literals != null && result.Literals.NoResults != null) {
                                t[t.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                            }
                    ...
                    for (var i = 0; i < result.Data.Count; i++) {
                        ...
                        if (_alert.Status.Code == 0) {
                            ...
                            if (_alert.ExecutivesChart != null) {
                                ...
                                if (result.Data.Alerts[i].IsGroupFolder == false) {
                                    if (result.Definition.DistributionType == 0 || result.Definition.DistributionType == 1) t[t.length] = this.addGetThisAlertUrl(_alert.ExecutivesChart.GetThisAlertUrl, result.Literals.GetThisAlert, mColor);
                                }
                            } else if (result.Literals != null && result.Literals.NoResults != null) {
                                t[t.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                            }
                    ...
                    for (var i = 0; i < result.Data.Count; i++) {
                        ...
                        if (_alert.Status.Code == 0) {
                            ...
                            if (_alert.RegionsChart != null) {
                                ...
                                if (result.Data.Alerts[i].IsGroupFolder == false) {
                                    if (result.Definition.DistributionType == 0 || result.Definition.DistributionType == 1) t[t.length] = this.addGetThisAlertUrl(_alert.RegionsChart.GetThisAlertUrl, result.Literals.GetThisAlert, mColor);
                                }
                            } else if (result.Literals != null && result.Literals.NoResults != null) {
                                t[t.length] = this.getNoResultsPanel(bgColor, fontFamily, contentFontSize, contentColor, result.Literals.NoResults);
                            }
            ...
            this.getInnerContainerStyle = function (bgColor, fontFamily, fontSize, fontColor) {
                return "background-color:" + bgColor + ";font-family:" + fontFamily + ";font-size:" + fontSize + ";color:" + fontColor + ";font-weight:normal;overflow:hidden" + ";padding:0 5px" + ";position:relative;";
            };
            this.getWidgetTitle = function (widgetName, bgColor, fontSize, fontColor, fontFamily, icon) {
                var t = [];
                t[t.length] = "<b style=\"font-family:Arial\">";
                t[t.length] = "<b style=\"" + "background-color:" + bgColor + ";margin:0 4px" + ";line-height:1px;height:1px;overflow:hidden;display:block;" + "\"></b>";
                t[t.length] = "<b style=\"" + "background-color:" + bgColor + ";border-left: solid 2px " + bgColor + ";border-right: solid 2px " + bgColor + ";margin:0 2px" + ";line-height:1px;height:1px;overflow:hidden;display:block;" + "\"></b>";
                t[t.length] = "<b style=\"" + "background-color:" + bgColor + ";margin:0 1px" + ";line-height:2px;height:2px;overflow:hidden;display:block;" + "\"></b>";
                t[t.length] = "</b>";
                t[t.length] = "<div id=\"fctv_AlertWidgetTitle\" style=\"" + "background-color:" + bgColor + ";padding:3px 5px" + ";padding-top:0px" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:bold;\">";
                if (icon) {
            ...
            this.getAlertTitle = function (_alert, _literals, bgColor, fontSize, fontColor, fontFamily) {
                var t = [];
                t[t.length] = "<div id=\"fctv_AlertTitle\" style=\"" + "position:relative;zoom:1" + ";background-color:" + bgColor + ";padding:3px 5px" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:bold" + "\">";
                t[t.length] = ((!(xSfr3 && xMac)) ? "<a href=\"" + _alert.ViewAllUri + "\" style=\"color:" + fontColor + "; text-decoration:none;\" onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\" onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\" onclick=\"if(FactivaWidgetRenderManager && FactivaWidgetRenderManager.getInstance()) {FactivaWidgetRenderManager.getInstance().xWinOpen(this.href);return false;}\" title=\"" + _literals.ViewAll + "\">" + _alert.Name + "</a>" : "<a href=\"" + _alert.ViewAllUri + "\" style=\"color:" + fontColor + "; text-decoration:none;\" onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\" onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\" target=\"_new\" title=\"" + _literals.ViewAll + "\">" + _alert.Name + "</a>");
                t[t.length] = "</div>";
                return t.join("");
            };
            this.getSectionTitle = function (_section, bgColor, fontSize, fontColor, fontFamily) {
                ...
                if (_section.Type == "Sub") {
                    t[t.length] = "<div style=\"padding-left:20px;\"><div id=\"fctv_AlertTitle\" style=\"" + "position:relative;zoom:1" + ";background-color:" + bgColor + ";padding:3px 5px" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:bold" + "\">";
            ...
            this.getNext = function (ele, tarDivCntrId, numHeadlines) {
                ...
                if (_tDiv) {
                    ...
                    if (_headlines && _headlines.length >= 1) {
                        ...
                        for (var i = tIndex;
                        (i < (tIndex + numHeadlines) && i < _headlines.length); i++) {
            ...
            this.getPagingBar = function (maxHeadlines, itemCount, _literals, bgColor, fontSize, fontColor, fontFamily, tarDivCntrId, _alert) {
                ...
                t[t.length] = "<div id=\"fctv_PagingCntr" + randomnumber + "\" class=\"PagingCntr\" style=\"" + "text-align:center;" + ";color:" + fontColor + ";font-size:" + fontSize + ";font-family:" + fontFamily + ";font-weight:normal" + "\">";
                ...
                if (_alert) {
                    ...
                    t[t.length] = ((!(xSfr3 && xMac)) ? "<a href=\"" + _alert.ViewAllUri + "\" style=\"color:" + fontColor + "; text-decoration:none;\" onclick=\"if(FactivaWidgetRenderManager && FactivaWidgetRenderManager.getInstance()) {FactivaWidgetRenderManager.getInstance().xWinOpen(this.href);return false;}\" title=\"" + _literals.ViewAll + "\" onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\" onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\">" + _literals.ViewAll + "</a>" : "<a href=\"" + _alert.ViewAllUri + "\" style=\"color:" + fontColor + "; text-decoration:none;\" target=\"_new\" onmouseover=\"FactivaWidgetRenderManager.getInstance().setMouseOver(this);return false;\" onmouseout=\"FactivaWidgetRenderManager.getInstance().setMouseOut(this);return false;\" title=\"" + _literals.ViewAll + "\">" + _literals.ViewAll + "</a>");
                }
                t[t.length] = "</div>";
                t[t.length] = "</div>";
                return t.join("");
                    ...
                    if (_tDivLeft < _cDiv.offsetLeft) {
                        ...
                        if (_tDiv.leftCarIndex >= 0) {
                            ...
                            if (_tDiv.edgeDistance == null) {
                                ...
                                if (temp == 0) this.xLeft(_tDiv, _tDiv.offsetLeft + carouselStack[--_tDiv.leftCarIndex] + 1);
                                else this.xLeft(_tDiv, _tDiv.offsetLeft + carouselStack[--_tDiv.leftCarIndex] + 2); if (_tDiv.leftCarIndex <= 0) {
                                    leftBtn.style.backgroundColor = "#DDDDDD";
                                }
                            }
