...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"  xmlns:user="user" extension-element-prefixes="msxsl" exclude-result-prefixes="user">
  ...
  <xsl:template match="//Result">
    <article>
      ...
      <xsl:if test="number(@status)=0">
        ...
        <xsl:choose>
          ...
          <xsl:when test="./CSet">
            <xsl:variable name="CSetCount">
              ...
              <xsl:choose>
                <xsl:when test="count(./CodeSet[@codeCat='djn']) > 0">
                  <xsl:value-of select="count(./CSet) + 1"/>
                </xsl:when>
                <xsl:otherwise>
            ...
            <xsl:if test="number($CSetCount)>0">
              <indexingCodeSets>
                ...
                <xsl:if test="count(./CodeSet[@codeCat='djn']) > 0">
                  <xsl:apply-templates select="./CodeSet"></xsl:apply-templates>
                </xsl:if>
              </indexingCodeSets>
            </xsl:if>
          </xsl:when>
          <xsl:when test="./CodeSets/CSet">
            <xsl:variable name="CSetCount">
              <!--<xsl:value-of select="count(./CSet[@fid='co'])+count(.//CSet[@fid='ns'])+count(.//CSet[@fid='re'])+count(.//CSet[@fid='in'])"/>-->
              <!-- This is done to include new CSet category effi-->
              ...
              <xsl:choose>
                <xsl:when test="count(./CodeSet[@codeCat='djn']) > 0">
                  <xsl:value-of select="count(./CodeSets/CSet[@fid='co'])+count(./CodeSets/CSet[@fid='ns'])+count(./CodeSets/CSet[@fid='re'])+count(./CodeSets/CSet[@fid='in'])+count(./CodeSets/CSet[@fid='efii']) + 1"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="count(./CodeSets/CSet[@fid='co'])+count(./CodeSets/CSet[@fid='ns'])+count(./CodeSets/CSet[@fid='re'])+count(./CodeSets/CSet[@fid='in'])+count(./CodeSets/CSet[@fid='efii'])"/>
                </xsl:otherwise>
              </xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:variable name="CSetCount">
              <xsl:choose>
                <xsl:when test="count(./CodeSet[@codeCat='djn']) > 0">
                  <xsl:value-of select="count(./Codes/CodeSet[@codeCat='co'])+count(./Codes/CodeSet[@codeCat='ns'])+count(./Codes/CodeSet[@codeCat='re'])+count(./Codes/CodeSet[@codeCat='in'])+count(./Codes/CodeSet[@codeCat='rst'])+count(./Codes/CodeSet[@codeCat='tpc']) + 1"/>
                </xsl:when>
                <xsl:otherwise>
        ...
        <xsl:apply-templates select="./DocData"></xsl:apply-templates>
        <xsl:apply-templates select="./PubData"></xsl:apply-templates>
  ...
  <xsl:template match="ArchiveDoc/Article">
    ...
    <xsl:variable name="CSetCount">
      <xsl:choose>
        ...
        <xsl:when test="count(./Codes/CodeSet[@codeCat='co'])+count(./Codes/CodeSet[@codeCat='ns'])+count(./Codes/CodeSet[@codeCat='re'])+count(./Codes/CodeSet[@codeCat='in'])+count(./Codes/CodeSet[@codeCat='rst'])+count(./Codes/CodeSet[@codeCat='tpc']) > 0">
          <xsl:value-of select="count(./Codes/CodeSet[@codeCat='co'])+count(./Codes/CodeSet[@codeCat='ns'])+count(./Codes/CodeSet[@codeCat='re'])+count(./Codes/CodeSet[@codeCat='in'])+count(./Codes/CodeSet[@codeCat='rst'])+count(./Codes/CodeSet[@codeCat='tpc'])"/>
        </xsl:when>
        <xsl:when test="count(./CodeSets/CSet[@fid='co'])+count(./CodeSets/CSet[@fid='ns'])+count(./CodeSets/CSet[@fid='re'])+count(./CodeSets/CSet[@fid='in'])+count(./CodeSets/CSet[@fid='efii']) > 0">
          <xsl:value-of select="count(./CodeSets/CSet[@fid='co'])+count(./CodeSets/CSet[@fid='ns'])+count(./CodeSets/CSet[@fid='re'])+count(./CodeSets/CSet[@fid='in'])+count(./CodeSets/CSet[@fid='efii'])"/>
        </xsl:when>
      </xsl:choose>
    </xsl:variable>
  ...
  <xsl:template match="Properties">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="./property[@name='accessionno']" />
        <xsl:apply-templates select="./property[@name='baselang']" />

        <xsl:apply-templates select="./property[@name='pubedition']"/>

        <xsl:if test="./property[@name='pubpage']">
          <pages>
            <xsl:apply-templates select="./property[@name='pubpage']"/>
          </pages>
        </xsl:if>
        <xsl:apply-templates select="./property[@name='pubdate']"/>
        <xsl:apply-templates select="./property[@name='publishern']"/>
        <xsl:apply-templates select="./property[@name='srccode']"/>
        <sourceLogo>
          <xsl:attribute name="image">
            <xsl:value-of select="normalize-space(./property[@name='logoimage']/@value)"/>
          </xsl:attribute>
          <xsl:attribute name="link">
            <xsl:copy-of select="normalize-space(./property[@name='logolink']/@value)"/>
          </xsl:attribute>
          <xsl:attribute name="source">
            <xsl:copy-of select="normalize-space(./property[@name='logosrc']/@value)"/>
          </xsl:attribute>
        </sourceLogo>
        <xsl:apply-templates select="./property[@name='srcname']"/>
        <xsl:apply-templates select="./property[@name='pubvol']"/>
        <xsl:apply-templates select="./property[@name='wordcount']"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template match="CodeSets/CSet">
    <!-- This is done to include efii CSet-->
    <xsl:if test="@fid='co' or @fid='ns' or @fid='re' or @fid='in' or @fid='efii'">
      <codeSet>
        <xsl:attribute name="codeCategory">
          <xsl:value-of select="@fid"/>
        </xsl:attribute>
  ...
  <xsl:template match="property[@name='accessionno']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <accessionNo>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </accessionNo>
  ...
  <xsl:template match="property[@name='baselang']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <baseLanguage>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </baseLanguage>
  ...
  <xsl:template match="property[@name='pubedition']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <edition>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </edition>
  ...
  <xsl:template match="property[@name='pubpage']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <page>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </page>
  ...
  <xsl:template match="property[@name='publishern']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <publisherName>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </publisherName>
  ...
  <xsl:template match="property[@name='srccode']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <sourceCode>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </sourceCode>
  ...
  <xsl:template match="property[@name='srcname']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <sourceName>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </sourceName>
  ...
  <xsl:template match="property[@name='pubvol']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <volume>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </volume>
  ...
  <xsl:template match="property[@name='wordcount']">
    <xsl:if test="string-length(normalize-space(@value)) &gt; 0">
      <wordCount>
        <xsl:value-of select="normalize-space(string(@value))"/>
      </wordCount>
