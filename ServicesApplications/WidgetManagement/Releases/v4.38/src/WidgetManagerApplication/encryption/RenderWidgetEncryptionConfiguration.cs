...
{
    internal class RenderWidgetEncryptionConfiguration
    {
        public static readonly string ACCOUNT_ID = "accountId";

        public static readonly string ENCRYPTION_KEY = "dharma";

        public static readonly string NAMESPACE = "namespace";

        public static readonly string USER_ID = "userId";

        public static readonly string WIDGET_ID = "wId";

        public static readonly string ALERT_ID = "alertId";
