...
namespace EMG.widgets.ui.controls.preview
{
    ...
    /// 
    /// </summary>
    public sealed class AlertWidgetPreviewControl : BaseControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertWidgetPreviewControl"/> class.
        /// </summary>
        public AlertWidgetPreviewControl() : base("div")
        {
            ID = "alrtWdgtPrvwCntrl";
