...
{
    ///<summary>
    /// Workspace Gallery Control
    ///</summary>
    public class WorkspaceWidgetGalleryControl : AbstractGalleryControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceWidgetGalleryControl"/> class.
        /// </summary>
        public WorkspaceWidgetGalleryControl()
        {
            ID = "wWidgetGalleryControl";
        ...
        private static Control GetTitleControl()
        {
            ...
            designTitle.InnerText = ResourceText.GetInstance.GetString("workspaceWidget");
            return designTitle;
        }
        ...
        private static Control GetDescription()
        {
            ...
            designTitle.InnerText = ResourceText.GetInstance.GetString("workspaceWidgetDescription");
            return designTitle;
        }
        ...
        private Control GetButton()
        {
            ...
            if (m_WidgetManagementDTO.IsValid())
            {
                ...
                {
                    hRef = string.Format(Settings.Default.BaseUrl_AutomaticWorkspaceWidget, SessionData.Instance().ProductPrefix, SessionData.Instance().AccessPointCode, m_WidgetManagementDTO.doneUrl);
                }
            }
            ...
            control.HRef = hRef;
            control.AltTag = string.Format("{0}", ResourceText.GetInstance.GetString("publishWorkspace"));
            return control;
        }
        ...
        private static Control GetImage()
        {
            ...
            imageControl.Src = "../img/widgets/workspace_widget_samp.png";
