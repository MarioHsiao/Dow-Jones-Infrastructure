...
namespace EMG.widgets.ui.delegates.output
{
    ...
    /// </summary>
    public abstract class AbstractWidgetDelegate : AjaxDelegate, ISessionBasedDelegate
    {
        ...
        /// <returns></returns>
        protected static WidgetDiscoveryTabCollection MapDiscoveryTabs(TabCollection tabCollection)
        {
            ...
            if (tabCollection != null && tabCollection.Count > 0)
            {
                ...
                foreach (Tab tab in tabCollection)
                {
                    if (tab != null)
                    {
                        ...
                        widgetDiscoveryTabCollection.Insert(tab.Position, widgetDiscoveryTab);
                    }
                }
            }
            return widgetDiscoveryTabCollection;
        }
