...
namespace EMG.widgets.ui.syndication.integration.alertWidget
{
    ...
    internal class LiveDotComGadget : AbstractWidgetPortalEndPoint
    {
        ...
        private const string m_BaseIntegrationUrl = "http://www.live.com/";
        private const string m_TemplateFileLocation = "~/syndication/integration/alertwidget/templates/livedotcomrss.xml";
