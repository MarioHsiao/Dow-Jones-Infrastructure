...
namespace EMG.widgets.ui.controls.design.automaticWorkspace
{
    /// <summary>
    /// 
    /// </summary>
    public sealed class DesignControl : AbstractWidgetDesignerControl
    {
        ...
        {
            m_Container.Controls.Add(GetTitleControl(ResourceText.GetInstance.GetString("design"), ResourceText.GetInstance.GetString("workspaceWidget")));
